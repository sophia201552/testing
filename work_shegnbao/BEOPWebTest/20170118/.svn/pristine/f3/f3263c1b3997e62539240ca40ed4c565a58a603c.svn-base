...
var DataWatch = (function () {
    ...
    DataWatch.prototype = {
        show: function () {
            ...
            WebAPI.get("/static/views/observer/widgets/dataWatch.html").done(function (resultHtml) {
                Spinner.spin(ElScreenContainer);
        ...
        initPoints: function () {
            ...
            WebAPI.post("/get_realtimedata_with_description_by_projname", { projid: AppConfig.projectId }).done(function (data) {
        ...
        initElement: function () {
            ...
            $('#btn_hist_curve').click(function(e){
                ...
                WebAPI.post("/get_history_data_ex", {
                    ...
                    new HistoryChart({data:data}).show();
                }).error(function (e) {
