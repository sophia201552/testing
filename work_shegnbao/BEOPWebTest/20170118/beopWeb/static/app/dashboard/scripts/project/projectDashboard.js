...
var ProjectDashboard = (function(){
    ...
    ProjectDashboard.navOptions = {
        top:
        '<span id="btnProjectMap" class="topNavLeft topTool" aria-hidden="true"><i class="iconfont">&#xe7e6;</i></span>' +
        '<div class="topNavTitle"><span id="dashboardName" class="topNavTitle"></span><span id="projName" class="topTip"></span></div>'+
