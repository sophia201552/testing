    ...
    WorkflowDetail.prototype = {
        ...
        initWkInfo:function(){
            try{
                ...
                createTime.innerHTML = new Date(store.createTime).format('yyyy-MM-dd HH:mm');
                ...
                var creator = this.container.querySelector('#createrInfo img');
                creator.src = 'http://images.rnbtech.com.hk' + this.store.creatorInfo.userpic;

                var creator = this.container.querySelector('#createrInfo .userName');
                creator.innerHTML = this.store.creatorInfo.userfullname;
        ...
        initComment:function(comment){
            ...
            comment.forEach(function(ele){
                ...
                item.className = 'divComment divUserInfo';

                var photo = document.createElement('span');
                photo.className = 'spPhoto userPic';
                photo.innerHTML = '<img src = "'+ ele.userInfo.userpic +'"/>';

                var spanNmTm = document.createElement('span');

                var name = document.createElement('div');
                name.className = 'spName userName';
        ...
        initOperate:function(){
            ...
            if(process.behaviour == 2){
                $btnOperateGrp.html('<span data-operate="0" class="btnOperate iconfont icon-kaishi zepto-ev"></span>');
