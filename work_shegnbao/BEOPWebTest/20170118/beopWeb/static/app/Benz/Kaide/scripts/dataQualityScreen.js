...
class DataQuality {
    ...
    init() {
        var _this = this;
        WebAPI.get('static/app/Benz/Kaide/views/DataQualityScreen.html').done(function (result) {
    ...
    initModule() {
        ...
        function getDataType(type) {
            ...
            data.forEach(function (element) {
                if (['Integrity', 'Validity', 'Relevance'].indexOf(type) != -1) {
        ...
        function setSeries() {
            var dataType = {
                'Integrity': ['完整性', '#1790CF'],
                'Validity': ['有效性', '#1C7099'],
                'Relevance': ['关联性', '#88B0BB']
            };
            var arr = [];
            var typeSeries = {};
