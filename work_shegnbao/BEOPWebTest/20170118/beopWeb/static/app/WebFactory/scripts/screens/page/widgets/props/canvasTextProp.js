        ...
        <li>\
            <ul class="list-inline" style="position: relative;">\
                ...
                <li id="liFloat" style="padding-top: 10px;">\
                    <label class="property-name exactNumber" style="width: auto;">精确位数:</label>\
