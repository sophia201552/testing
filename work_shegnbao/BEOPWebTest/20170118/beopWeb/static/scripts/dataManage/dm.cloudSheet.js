(function (beop) {
    var configMap = {
        ...
        loadTree, changeToZTreeNodes,
        enlargeFullScreen, batchAllPointsChange, btnPreservation, tableCopyBoxStyle, getApiFolderNameList;
    ...
    editCancel = function () {
        stateMap.$treeDomDetach = $("#dmSysTree").detach();
    ...
    joinCurve = function () {
        ...
        if (!selectedPoints.length) {
            ...
            if (selectedPoints.length == 1) {
                ...
                if (selectedPoints[0].pointValue && isNaN(selectedPoints[0].pointValue) && selectedPoints[0].pointValue != 'None') {
            ...
            beop.tag.tree.configModel(
                {
                    ...
                    cb_on_dbl_click: function (treeNode) {
                        if (!treeNode.isParent) {
                            stateMap.editor.replaceSelection(treeNode.sample ? treeNode.sample : treeNode.name);
                        }
                    },
