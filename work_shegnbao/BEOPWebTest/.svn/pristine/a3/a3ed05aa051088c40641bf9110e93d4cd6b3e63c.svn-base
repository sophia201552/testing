var PageEditModal = (function () {
    ...
    PageEditModal.prototype.init = function() {
        ...
        _this.$divBg.removeAttr("data-bg");
    ...
    PageEditModal.prototype.attachEvents = function() {
        ...
        _this.$bgBtton.off("click").on("click",function(){
            WebAPI.get('/static/app/WebFactory/scripts/modals/bgModal/bgProp.html').done(function(resultHTML){
                ...
                $("#divBg").attr("data-bg","");
                if(typeof(_this.src.option) === "undefined" || typeof(_this.src.option.background) === "undefined" || _this.src.option.background.type == ""){
        ...
        _this.$btnOk.off().click(function(e) {
            ...
            if(typeof(pageBg) === "undefined"){
                if(typeof(_this.src.option) === "undefined" ){
                    ...
                    var objPageCfg = {projId:projId, name:pageName, type:pageType, width:pageWidth, height:pageHeight, display:pageDisplay,reportType:reportType,reportFolder:pageUrl,iconSkin:pageIcon,option:{background:_this.src.option.background,variables:_this.src.option.variables}};
