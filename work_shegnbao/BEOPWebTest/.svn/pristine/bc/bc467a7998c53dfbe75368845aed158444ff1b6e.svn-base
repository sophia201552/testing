(function (beop) {
    ...
    var trans_id,
        ...
        updateTrans, addReply, faultCurve, faultCurveByParam, getReply, getProgress, completeTrans, verifyPass, verifyNotPass, toggleStarred, collectionTrans, listTransStarBy, listNewCreated, listStartedTrans, listWaitVerify, startTransaction
    ...
    transactionsModel = (function () {
        ...
        faultCurveByParam = function (params) {
            return emit(beop.apiMap.faultCurveByParam, {
                projectId: params.projectId,
                chartPointList: params.chartPointList,
                chartQueryCircle: params.chartQueryCircle,
                chartStartTime: params.chartStartTime,
                chartEndTime: params.chartEndTime
            }).done(function (result) {
                stateMap.cur_fault_curve = result.data;
            });
        };
        ...
        return {
            ...
            faultCurveByParam: faultCurveByParam,
