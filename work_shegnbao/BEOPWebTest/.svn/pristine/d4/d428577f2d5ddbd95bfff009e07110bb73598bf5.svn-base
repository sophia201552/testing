    ...
    workflowNoticeDetail.prototype = {
        ...
        refreshProcessRecord: function () { //工单流程记录
            ...
            for (var i = 0; i < this.model.status_flow.length; i++) {
                ...
                if (i == 0) {
                    html += '<dl><dt><img src="' + data.userpic + '" class="processUser processSuccess"></dt><dd class="userName" title="' + data.userfullname + '">' + data.userfullname + '</dd></dl><div class="processInfo"><h4 i18n="workflow.process.ASSIGNMENT_TASK"></h4><img src="/static/images/workflow/processNext.png" class="processNext processSuccess"><time></time></div>';
                } else if (i == 1) {
                    ...
                    if (data.length != 0) {
                        ...
                        if (data.length == 1) {
                            html += '<div class="processInfo"><h4 i18n="workflow.process.FORWARD"></h4><img src="/static/images/workflow/processNext.png" class="processNext processSuccess"><time></time>' + forwardTime + '</div><dl><dt><img src="' + this.model.status_flow[3].userpic + '" class="processUser processSuccess"></dt><dd class="userName" title="' + data[0].executor.new + '">' + data[0].executor.new + '</dd></dl>';
                        } else if (data.length > 1) {
                            html += '<div class="processInfo"><h4 i18n="workflow.process.FORWARD"></h4><img src="/static/images/workflow/processNexts.png" id="assignInfo" class="processNext processSuccess"><time>' + forwardTime + '</time></div><dl><dt><img src="' + this.model.status_flow[3].userpic + '" class="processUser processSuccess"></dt><dd class="userName" title="' + data[0].executor.new + '">' + data[0].executor.new + '</dd></dl>';
                        }
                    }
                } else if (i == 3) {
                    if (data.flowStatus == 1) {
                        ...
                        html += '<div class="processInfo"><h4 i18n="workflow.process.PROCESSING"></h4><img src="/static/images/workflow/processNext.png" class="processNext processSuccess"><time>' + handleTime + '</time></div><dl><dt><img src="/static/images/workflow/wf-complete.png" class="processUser processSuccess"></dt><dd class="userName" i18n="workflow.process.COMPLETE"></dd></dl>';
                    } else {
                        html += '<div class="processInfo"><h4 i18n="workflow.process.PROCESSING"></h4><img src="/static/images/workflow/processNext.png" class="processNext"><time></time></div><dl><dt><img src="/static/images/workflow/wf-complete.png" class="processUser"></dt><dd class="userName" i18n="workflow.process.COMPLETE"></dd></dl>';
                    }
                } else if (i == 4) {
                    if (data.flowStatus == 1) {
                        var authenticationTime = _this.getRecordTime(this.model.status_flow[3].opTime, this.model.status_flow[4].opTime);
                        html += '<div class="processInfo"><h4 i18n="workflow.process.VERIFY"></h4><img src="/static/images/workflow/processNext.png" class="processNext processSuccess"><time>' + authenticationTime + '</time></div><dl><dt><img src="/static/images/workflow/wf-verified.png" class="processUser processSuccess"/></dt><dd class="userName" i18n="workflow.process.VERIFY"></dd></dl>'
                    } else {
                        html += '<div class="processInfo"><h4 i18n="workflow.process.VERIFY"></h4><img src="/static/images/workflow/processNext.png" class="processNext"><time></time></div><dl><dt><img src="/static/images/workflow/wf-verified.png" class="processUser"/></dt><dd class="userName" i18n="workflow.process.VERIFY"></dd></dl>'
                    }
                }
            }
            html += '</li>';
