...
(function ($) {
    var infoBoxBase = {
        ...
        _createBox: function () {
            ...
            infoBoxMsgBox.append('<div class="infoBox-msg" style="margin: 0;">' + me.options.msg + '</div>');
            if (me.options.input) {
    ...
    function infoBoxPrompt(msg, callback, options) {
        var _this = this;
    ...
    infoBox.prompt = function (msg, callback, options) {
