(function (beop) {
        ...
        restoreEditStatus = function () {
            ...
            jqueryMap.$container.hide();
            jqueryMap.$wf_label_icon_wrapper.hide();
            jqueryMap.$wrapper.find('#wf-label-toggle').removeClass("wf-tags-ul-show").addClass("wf-tags-ul-hide");
        };
        ...
        sendDataToBack = function () {
            ...
            function updateTag() {
                if (updateTagsLength !== 0) {
                    return configMap.tags_model.editTag({user_id: UserID}, stateMap.tagDataList.update).fail(function () {
                    })
                } else {
                    return true;
                }
            ...
            function addNewTag() {
                if (newTagsLength !== 0) {
                    return configMap.tags_model.addTag({user_id: UserID}, stateMap.tagDataList.new).fail(function () {
