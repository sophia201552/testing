(function (WidgetProp) {
    ...
    CanvasHeatPProp.prototype.tplPrivateProp = '\
        <li>\
            <ul class="list-inline tempFont">\
                ...
                <li id="prop-fontColor"><label class="property-name">color:</label><input id="inputColor" style="display:inline-block;width:50px;padding: 2px;" type="text" value="{fontColor}"/></li>\
                <li id="prop-unitType"><label class="property-name">unit:</label><input id="inputUnitType" style="display:inline-block;width:50px;padding: 2px;" type="text" value="{unitType}"/></li>\
            </ul>\
        </li>\
       <li>\
            <ul class="list-inline" style="position: relative;">\
                ...
                <li id="liEnumerateWrap" style="padding-top: 10px;display:none">\                    <div class="divTool">\
    ...
    CanvasHeatPProp.prototype.show = function () {
		...
		var model = this.store.model,
            ...
            isDisabled = ' disabled';        var opt = model.option();
        var defaultOpt = {
    ...
    CanvasHeatPProp.prototype.attachEvent = function () {
        ...
        $('#inputUnitType,#inputSize,#inputColor').off('blur').on('blur', function () {
