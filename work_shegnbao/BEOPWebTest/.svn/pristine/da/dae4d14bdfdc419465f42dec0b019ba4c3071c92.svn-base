(function (beop) {
    ...
    bindEvents = function () {
        ...
        jqueryMap.$add_user_dialog.off().on('show.bs.modal', function () {
            ...
            if (stateMap.hasFrame) {
                jqueryMap.$wf_check_result.empty().html(beopTmpl('tpl_wf_dialog_added_member', {members: stateMap.userHasSelectedDefault}, window.frames[0].document.getElementById("tpl_wf_dialog_added_member").innerHTML))
            } else {
    ...
    renderAddedUsers = function () {
        if (stateMap.hasFrame) {
            jqueryMap.$wf_added_user_list.html(beopTmpl('tpl_wf_dialog_added_member', {members: stateMap.userHasSelectedDefault}, window.frames[0].document.getElementById("tpl_wf_dialog_added_member").innerHTML));
        } else {
    ...
    renderCheckedUsers = function (data) {
        ...
        if (stateMap.hasFrame) {
            jqueryMap.$wf_check_result.html(beopTmpl('tpl_wf_dialog_added_member', {members: data}, window.frames[0].document.getElementById("tpl_wf_dialog_added_member").innerHTML))
        } else {
    ...
    progressResultData = function () {
        ...
        if (stateMap.hasFrame) {
            ...
            }, window.frames[0].document.getElementById("tpl_wf_member").innerHTML));
        } else {
            jqueryMap.$wf_search_result.html(beopTmpl('tpl_wf_member', {
                members: stateMap.allUserList,
                addUserMap: addedUserMap
