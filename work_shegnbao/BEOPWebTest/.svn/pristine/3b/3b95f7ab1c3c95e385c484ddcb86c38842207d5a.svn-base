...
var ObserverScreen = (function () {
    ...
    ObserverScreen.prototype = {
        ...
        stop: function () {
            ...
            if (this.workerUpdate) { this.workerUpdate.terminate(); this.workerUpdate = null; }
        },
        ...
        initToolBar: function (ins) {
            ...
            var $btnDropdownNavList = $('#btnDropdownNavList');
        ...
        enterBacktraceMode: function (screen, e) {
            ...
            if (_this.workerUpdate) { this.workerUpdate.terminate(); this.workerUpdate = null; }
            ...
            if (this.isInDiagnosis) {
                ...
                if(AppConfig.projectId == 80) {
                    getErrDataNew = function (id) {
                        ...
                        for (var t in dicEquipments) {
                            if (dicEquipments[t].modalTextId === id) {
                                dataNew = dataNew.concat(dicEquipments[t].name);
                            }
                        }
                        return dataNew;
                    };
                ...
                for (var i = 0; i < this.store.texts.length; i++) {
                    ...
                    if (this.isInDiagnosis) {
                        ...
                        if (modalTextIds[item.id]) {
                            ...
                            this.diagScreen.dictObserverText[modalTextIds[item.id]] = tempText;
        ...
        addImageIntoRequestQueue: function (id) {
            ...
            var img = new Image();
            img.src = new StringBuilder().append("http://images.rnbtech.com.hk/static/images/plant/").append(AppConfig.projectName).append("/").append(id).append(".png").toString();
