        ...
        attachEvents: function () {
            ...
            this.$container.on("click", "#workflow-insert-submit", function () {
                if (_this.submitCheck()) {//表单校验
                    ...
                    $.when(WebAPI.get('/diagnosis/notice/makesure/' + submitModel.projectId + '/' + submitModel.noticeId + ''),
            ...
            $("#btn_insert_ok").click(function () {
                _this.insertFunc && typeof _this.insertFunc === 'function' ? _this.insertFunc() : ScreenManager.show(DiagnosisScreen);
            });
