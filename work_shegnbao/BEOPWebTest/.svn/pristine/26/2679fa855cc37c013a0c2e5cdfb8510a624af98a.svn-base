(function ($, undefined) {
    ...
    Table.prototype.loading = function () {
        // hide table footer
        this.$tblFooter.hide();
        this.$tbody.html('<tr><td class="ui-tbl-col-i-info" col-span="'+this.options.columns.length+'"><img src="http://images.rnbtech.com.hk/static/images/ballsline.gif" alt="loading" /></td></tr>');
    };
