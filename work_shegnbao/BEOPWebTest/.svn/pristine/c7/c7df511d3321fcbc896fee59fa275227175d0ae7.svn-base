var modalConfigurePane = (function(){
    ...
    modalConfigurePane.prototype = {
        ...
        showModalInit: function(optionType,option,templateObj){
            ...
            !_this.option.dataTypeMaxNum && (_this.option.dataTypeMaxNum = [5]);
            this.init();
        ...
        init: function () {
            ...
            $modalConfig.off('hidden.bs.modal').on('hidden.bs.modal', function () {
                $modalConfig.find('#dataConfig').html('<div><span I18n="modalConfig.data.DATA_CONFIG_TITLE_PRE"></span><span I18n="modalConfig.data.DATA_CONFIG_TITLE_TYPE1"></span></div>');
        ...
        initConfigData: function(){
            ...
            var strTempDataTitle = '<span>'+ I18n.resource.modalConfig.data.DATA_CONFIG_TITLE_TYPE2 + '</span>';
            strDataTitle = strDataTitle.replace('5',_this.option.dataTypeMaxNum[0]);
        ...
        initTime: function(){
            ...
            if(_this.optionType && !sessionStorage.getItem('timeStart') && !sessionStorage.getItem('timeEnd')) {
                var now = new Date();
