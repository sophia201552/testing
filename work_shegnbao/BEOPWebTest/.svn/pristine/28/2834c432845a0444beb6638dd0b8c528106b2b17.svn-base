...
var WorkflowTool = (function () {
    var pic_path = 'http://images.rnbtech.com.hk/static/images/workflow/', templateStorage;
            ...
            for (var prop in text) {
                if (prop == 'critical') {
                    ...
                    if (prop != 'assignTime') {
                        ...
                        html += '<li><span class="historyConTitle">' + Translation(prop) + '：</span> <span class="newName" style="margin-left:0">' + text[prop].new ? text[prop].new : text[prop] + '</span></li>';
                    }
                }
