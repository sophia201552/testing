...
var BasicInfo = (function(){
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    result.data.forEach(function(i){
                        _this.$divAssetImg.html('<div class="imgItem"><img src="http://images.rnbtech.com.hk/' + i + '?_=' + timestamp + '" class="imgAsset" id="imgAsset"/></div>');//
                    });
                }
            })
        });
    ...
    BasicInfo.prototype.save = function(){
        var urlImg = this.$divAssetImg.find('img').attr('src');
