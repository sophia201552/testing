var DiagnosisConfig = (function () {
    ...
    DiagnosisConfig.prototype = {
        ...
        init:function(){
            _this.isInit = true;
            WebAPI.get('/diagnosis/limit/get/'+ AppConfig.projectId).done(function(result){
                _this.limitList = JSON.parse(result);
            ...
            WebAPI.get('/diagnosis/order/get/'+ AppConfig.projectId).done(function(result){
                _this.orderList = JSON.parse(result);
            ...
            WebAPI.get('/diagnosis/enable/get/'+ AppConfig.projectId).done(function(result){
                _this.enableList = JSON.parse(result);
...
var DiagnosisFaultConfig = (function () {
    ...
    DiagnosisFaultConfig.prototype = {
        show: function () {
            ...
            $.get("/static/views/observer/diagnosis/paneFaultConfiguration.html").done(function (resultHtml) {
                var dialog = $('#dialogModal');
                dialog.find('#dialogContent').html(resultHtml);
