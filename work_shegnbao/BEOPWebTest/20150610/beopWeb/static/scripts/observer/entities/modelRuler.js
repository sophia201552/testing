...
var ModelRuler = (function () {
    ...
    function drawReferrencePanel(context, x, y, w, h, isCurrentProject) {
        ...
        geometry.fillRadiusRect(x, y, w, h, 3);
        context.fill();
