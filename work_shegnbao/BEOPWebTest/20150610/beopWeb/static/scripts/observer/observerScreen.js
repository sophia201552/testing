...
var ObserverScreen = (function () {
    function ObserverScreen(id, container) {
        this.id = id;
    ...
    ObserverScreen.prototype = {
        show: function () {
            var _this = this;
            AL.when('observer').then(function () {
        ...
        initToolBar: function () {
            ...
            if (this.isInDiagnosis) ToolCurrent = new TimeShaft(_this);
        },
        ...
        initScreen: function () {
            ...
            if (this.isDetailPage) {
                ...
                Spinner.spin(_this.container.getElementsByClassName('modal-body')[0]);
        ...
        initTexts: function () {
            ...
            var modalTextIds = [];
            var dicEquipments, dicFaults, getErrData;
                ...
                getErrData = function (id) {
                    ...
                    for ( var t in dicEquipments ) {
                        if( dicEquipments[t].modalTextId === id ) {
                            data = dicEquipments[t].faultIds.concat();
                            break;
                        }
                    }
                    return data;
            ...
            if(this.isInDiagnosis) {
                for( var i in dicEquipments ) {
                    modalTextIds.push(dicEquipments[i].modalTextId);
                }
            }
            ...
            if (this.store.texts) {
                ...
                for (var i = 0; i < this.store.texts.length; i++) {
                    ...
                    if (this.isInDiagnosis) {
                        ...
                        if( modalTextIds.indexOf(item.id) > -1 ) {
                            tempText.color = 'rgb(255, 0, 0)';
                            ...
                            tempText.retrunToMoment = function (date) {
                                ...
                                var time = DateUtil.parseStringToDate(date);
