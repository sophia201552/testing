(function () {
    ...
    EnergyScreen.prototype.getLayoutData = function () {
        ...
        for (var i = 0; i < this.arrEntityOrder.length; i++) {
            ...
            if ( ['ModalHistoryDataAnalyze','ModalAppKPICollect','ModalDataMonitorList','ModalMobileWorkDiagnosis','ModalObserver', 'ModalNote', 'ModalMix', 'ModalHtml', 'ModalChartCustom', 'ModalWeather', 'ModalReportFactory','ModalAppButton','ModalAppPie','ModalRealtimeWeather','ModalCumulantChart'].indexOf(entity.modal.type) > -1 ) {
                arrEntity.push(entity);
