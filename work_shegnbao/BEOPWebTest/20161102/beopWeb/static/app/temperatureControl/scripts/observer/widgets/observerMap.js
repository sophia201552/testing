var ObserverMap = (function(){
    ...
    function ObserverMap(page){
        ...
        this.mapScreenTop = getOffsetSum($('#divObserverMap')[0]).top + parseFloat(this.page.mapPadding.top);
    ...
    ObserverMap.prototype = {
        ...
        imgOnloadMove: function () {
            ...
            if (lastGps) {
                ...
                $('#divSetTempHis').css({
                    left:mapConfig.imgX + $spanLocateIcon.width()/2 + _this.page.mapPadding.left,
                    top:mapConfig.imgY - $spanLocateIcon.height() + _this.mapScreenTop - 20
                });
            }
        },
        imgMapMove: function () {
        ...
        resizeCalc:function(){
            ...
            $divSetTempHis.css({
                left:mapConfig.imgX + $spanLocateTool.width()/2 + _this.page.mapPadding.left + 30,//mapConfig.imgX,$spanLocateTool.width()都是0, 因为还没加载到页面
                top:mapConfig.imgY - $spanLocateTool.height() + _this.mapScreenTop - 20
            });
            $containerMap.css({
                left:mapConfig.offsetX - _this.page.mapPadding.left,
        ...
        initLocate: function(){
            ...
            this.mapEvent.off('tap').on('tap',function(e){
                ...
                mapConfig.imgX = ev.pointers[0].pageX - mapConfig.offsetX;
                mapConfig.imgY = ev.pointers[0].pageY  - mapConfig.offsetY;
                $locateTool.css({
                    left:mapConfig.imgX - $spanLocateTool.width()/2 + _this.page.mapPadding.left,
                    top:mapConfig.imgY - $spanLocateTool.height() + _this.mapScreenTop
                });
            ...
            $locateTool.hammer().off('panend').on('panend',function(e){
                ...
                mapConfig.imgX = ev.changedPointers[0].pageX - _this.page.mapPadding.left - mapConfig.offsetX;
            ...
            this.mapEvent.off('panstart').on('panstart',function(e){
                ...
                initOffsetX = mapConfig.offsetX;
                initOffsetY = mapConfig.offsetY;
            });
            this.mapEvent.off('panmove').on('panmove',function(e){
                //e.preventDefault();
                var ev = e;
                var evLeft = ev.pointers[0].pageX - initimgX + initOffsetX - _this.page.mapPadding.left;
        ...
        unitRelocate:function(){
            ...
            for (var i = 0; i < arrUnit.length ;i++){
                ...
                unit.style.top = arrUnit[i].dataset.y * mapConfig.scale + _this.mapScreenTop + 'px';
            }
        ...
        offsetAdjust:function(){
            ...
            if (mapConfig.offsetY < - ($containerMap[0].offsetHeight - divMapHeight - _this.mapScreenTop)){
                mapConfig.offsetY = - ($containerMap[0].offsetHeight - divMapHeight - _this.mapScreenTop)
            }
            if (mapConfig.offsetX > _this.page.mapPadding.left){
                mapConfig.offsetX = _this.page.mapPadding.left
            }
            if (mapConfig.offsetY > _this.mapScreenTop){
                mapConfig.offsetY = _this.mapScreenTop
            }
        },
        getRealPos:function(){
