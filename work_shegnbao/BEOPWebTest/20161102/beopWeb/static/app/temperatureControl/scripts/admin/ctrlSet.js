    ...
    CtrlSet.prototype = {
        show: function (parent, type, device, isNotRequestData) {
            ...
            if (device) {
                ...
                var maxLeft = Math.max(0, ($ul.width() - $('body').width()));
        ...
        init: function (isNotRequestData) {
            ...
            if(this.type != 'sensor' && (ctrAll || ctrAll.length > 0)){
                this.container.style.width = 125 * ctrAll.length + 'px';
                ...
                this.container.style.width = 125 * sensorAll.length + 'px';
...
var CtrlItem = (function(){
    ...
    CtrlItem.prototype = {
        tplDevice: '<li>\
            <div class="deviceScreen" id="ds_{id}">\
                <div class="head">\
                    <span class="iconfont icon-medium icon-xinhao3 signal" id="{signalId}"></span>\
                    <span class="iconfont icon-medium icon-dianliangtiao0 electricity" id="{electricityId}"></span>\
                </div>\
                <div class="checkBox">\
        ...
        tplMode: '<li>\
            <div class="deviceScreen" id="ds_{FCUId}">\
                <div class="FCUIcon">\
        ...
        tplSensor:'<li>\
            <div class="deviceScreen" id="ds_{id}">\
                <div class="head">\
                    ...
                    <span class="iconfont icon-medium icon-dianliangtiao0 electricity" id="{SensorBatteryId}"></span>\
                </div>\
                <div class="headMsg">\
                    <div>{name}</div>\
                </div>\
                    ...
                    opt.series.push({
                        ...
                        markLine: {
                            ...
                            data: [
                                ...
                                {
                                    "name": "Setting",
                                    "yAxis": curRoom.params.tempSet ? curRoom.params.tempSet : null,
                                    itemStyle: {
