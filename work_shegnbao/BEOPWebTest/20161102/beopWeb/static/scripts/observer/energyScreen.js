    ...
    EnergyScreen.prototype = {
        ...
        initToolBar: function () {
            ...
            if (this.isForReport) {
                ...
                if (AppConfig.permission.DBWrite) {
        ...
        initLayout: function () {
            ...
            if (this.options.isForMobile)this.$obCanvasContainer.addClass('forMobile');
            var _this = this;
        ...
        saveLayout: function () {
            ...
            for (var i = 0; i < this.arrEntityOrder.length; i++) {
                ...
                if (['ModalAppKPICollect', 'ModalObserver', 'ModalNote', 'ModalMix', 'ModalHtml', 'ModalChartCustom', 'ModalWeather', 'ModalReportFactory', 'ModalRealtimeWeather','ModalCumulantChart'].indexOf(entity.modal.type) > -1) {                    // 传说中的后门
