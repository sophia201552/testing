...
var ModalHistoryChartNormal = (function () {
    ...
    ModalHistoryChartNormal.prototype.modalInit = function(){
        ...
        var configModalOpt = {
            ...
            result:{func: data =>{
                !this.entity.modal.option && (this.entity.modal.option = {});
                this.entity.modal.option.mode = data.mode;
                this.entity.modal.option.format = data.format;
                if(data.mode === '1'){
                    this.entity.modal.option.startTime = data.startTime;
                    this.entity.modal.option.endTime = data.endTime;
                }else if(data.mode === '2'){
                    this.entity.modal.option.unit = data.unit;
                    this.entity.modal.option.val = data.val;
                }
                this.entity.modal.option.showType = data.selChartType.val;
                this.entity.modal.option.recentTime = data.recentTime;

                this.entity.modal.points = data.points[0];
                this.renderModal();
            }}
        };
...
var ModalHistoryChartYearOnYearLine = (function () {
    ...
    ModalHistoryChartYearOnYearLine.prototype.modalInit = function(){
        ...
        var configModalOpt = {
            ...
            result:{func: data =>{
                !this.entity.modal.option && (this.entity.modal.option = {});
                this.entity.modal.option.mode = 0;
                this.entity.modal.option.format = 'h1';

                this.entity.modal.option.showType = data.selChartType.val;
                this.entity.modal.option.recentTime = 'yesterday';
