...
var ModalBase = (function () {
    ...
    function ModalBase(parent, entity, _funcRender, _funcUpdate,_funcConfigMode, configModalOpt) {
        if (!parent) return;
        this.screen = parent;
        this.entity = entity;
        this.wikis = {};
    ...
    ModalBase.prototype = {
        ...
        modalInit: function() {
            ...
            //deal with 图元 报表章节
            if(['ModalReportChapter', 'ModalReportFactory'].indexOf(_this.optionTemplate.type) > -1) {
