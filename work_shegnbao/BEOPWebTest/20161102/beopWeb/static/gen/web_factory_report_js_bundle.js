...
;(function (exports) {
    ...
    +function () {
        ...
        this.continueSave = function (){
            if(this.screen.screen && this.screen.screen.pagePanel){
                this.screen.replacePageSave();
            }
        }
        this.close = function () {
            if (this.$container) {
...
(function(exports, ReportTplParamsPanel) {
    ...
    ReportTplParamsConfigModal.prototype.attachEvents = function () {
        ...
        this.$btnClose.off().on('click',function(e){
            _this.$modal.modal('hide');
            _this.reportTplParamsPanel.continueSave();
            e.preventDefault();
        })
    };
...
;(function (exports, SuperClass) {
    ...
    +function () {
        ...
        this.recoverForm = function(options) {
            ...
            if(form.lengends){
                form.lengends.forEach(function(lengend,i){
                    $($('.drop-text')[i]).show();
