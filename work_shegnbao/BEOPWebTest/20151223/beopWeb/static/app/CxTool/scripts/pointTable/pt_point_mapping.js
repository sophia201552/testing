(function (beop) {
    ...
    var configMap = {
        ...
        stateMap = {
            ...
            sheetHeaders: Math.max(document.documentElement.clientHeight, window.innerHeight || 0) <= 768 ?
                ...
                [i18n_sheetHeaders.CLOUD_POINT, i18n_sheetHeaders.COMMENT, i18n_sheetHeaders.SITE_POINT, i18n_sheetHeaders.SITE_POINT_NOTES, i18n_sheetHeaders.REAL_TIME_DATA, i18n_sheetHeaders.REAL_TIME_DATA, i18n_sheetHeaders.MAPPING],
            changedList: {},
            currentPage: 1,
        ...
        onSelectEnginePoint, onDisplaySelected, onPointMapping, onUndoPoint, onRedoPoint, onSearchTextKeyDown,
    ...
    refreshMappingInfo = function (row, point) {
        var mapping = point['mapping'];
        for (var prop in mapping) {
            if (mapping.hasOwnProperty(prop)) {
                stateMap.sheetInstance.setDataAtRowProp(row, 'mapping.' + prop, point['mapping'][prop]);
            }
        }
    };
    ...
    renderSheet = function (data) {
        ...
        if (stateMap.sheetInstance) {
            ...
            var bigScreenColumns = [
                ...
                {
                    data: function (data) {
                        return !!(data && !$.isEmptyObject(data.mapping) && data.mapping.point);
                    },
                    type: 'checkbox',
                    width: "50px"
                }
            ...
            stateMap.sheetInstance = new Handsontable(jqueryMap.$sheet.get(0), {
                ...
                fixedColumnsLeft: isSmallScreen ? 1 : 4,
...
//---------事件---------
    ...
    onSelectEnginePoint = function () {
        stateMap.mappingPoint = $(this).val();
    };
