                ...
                <li>\
                    ...
                    <div class="btn-group">\
                      ...
                      <ul class="dropdown-menu" id="txtStyle">\
                        <li data-style="style1"><a href="#" class="txtStyle1">style1</a></li>\
                        <li data-style="style2"><a href="#" class="txtStyle2">style2</a></li>\
                        <li data-style="style3"><a href="#" class="txtStyle3">style3</a></li>\
                        <li data-style="style4"><a href="#" class="txtStyle4">style4</a></li>\
                      </ul>\
                    </div>\
                </li>\
                <li class="txtShow">\
...
(function (PropModel) {
    ...
    HtmlTextPropModel.prototype.option = function (params) {
