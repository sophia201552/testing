    ...
    MenuConfigure.prototype = {
        ...
        bindEvents: function () {
            ...
            $con.off('change', 'select').on('change', 'select', function () {
                ...
                $li.find(".itemInfo").html('<input type="text" value="" class="form-control displayName menuName" placeholder="请填入显示名称" draggable="true" />');
                if ($this.hasClass("mainMenu")) { //一级菜单
                    ...
                    if (val == menuType.DropDownList) { //下拉菜单
                        $configDropDownDenuUl.html(beopTmpl('three_nav_tmpl', _this.viewModel)).slideDown(100);
            ...
            $con.on('click', '.itemEdit', function () {
                ...
                if ($mainMenu.val() == menuType.DropDownList) {
                    ...
                    $itemInfo.html('<input type="text" originalValue="' + mainMenuText + '" value="' + mainMenuText + '" class="form-control displayName menuName" placeholder="请填入显示名称" draggable="true" />');
                    ...
                    $itemInfo.html('<input type="text" originalValue="' + mainMenuText + '" value="' + mainMenuText + '" class="form-control displayName menuName" placeholder="请填入显示名称" draggable="true" />').append(beopTmpl('operating_Report_tmpl'));
