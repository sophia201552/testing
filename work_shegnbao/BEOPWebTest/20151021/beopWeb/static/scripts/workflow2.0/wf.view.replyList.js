(function (beop) {
    var configMap = {
        ...
        setJqueryMap,
        configModel,
        init, onReplySubmit, refreshReply, bindImgZoom, imgZoom;
    ...
    init = function ($container) {
        ...
        configMap.transactions_model.getReply().done(function (result) {
            if (result.success) {
                $container.html(beopTmpl('tpl_detail_reply', result));
                $container.find('#wf-reply-table').html(beopTmpl('tpl_reply_table_body', result));
                setJqueryMap();
