    ...
    IndexScreen.prototype = {
        show: function () {
            ...
            if (I18n.type == 'en') {
                ...
                $('#indexMain').on('mousewheel',function (e) {
                    location.href = '/static/views/homeSlider/showPage.html';

                    //e = e || window.event;
                    //if (e.wheelDelta < 0) {
                    //$.get('/static/views/homeSlider/showPage.html').done(function (result) {
                    //    if ($('.section').length == 0) {
                    //        $(result).insertAfter($('#indexMain'));
                    //    }
                    //    $('#indexMain').css('transform', 'translateY(-100%)');
                    //    $('.totalDown').hide();
                    //})
                    //}
                });
        ...
        initResetPassword: function () {
            ...
            $passwordResetBtn.click(function () {
                ...
                Spinner.spin($("#resetPasswordModal .modal-content").get(0));
