var ScreenManager = (function () {
            ...
            if (Boolean(curId)) {
                ...
                if (Boolean(m_dictScreen[curId])) {
                    ...
                    if ('PaneProjectSelector' == preScreenName && 'PaneProjectSelector' != nowScreenName) {
                        if (Boolean(panPrjSel) && Boolean(AppConfig.projectId)) {   // init nav
    ...
    ScreenManager.show = function () {
        ...
        if ('PaneProjectSelector' == screenClass.name && Boolean(ScreenCurrent)) {
