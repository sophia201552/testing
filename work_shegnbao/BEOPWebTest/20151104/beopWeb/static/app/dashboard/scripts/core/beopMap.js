...
(function (beop) {
    ...
    BeopMap.prototype.initPaneProject = function () {
        ...
        this.$projectInfo.hammer().on('swipedown',function () {
            $('.iconHide').css('display','none');
            $('.iconShow').css('display','inline-block');
            _this.$projectInfo.animate({
                opacity: 0.25,
        ...
        this.$projectInfo.hammer().on('swipeup',function () {
            $('.iconHide').css('display','inline-block');
            $('.iconShow').css('display','none');
            _this.$projectInfo.animate({
                opacity: 1,
        ...
        this.$projectInfo.hammer().on('swipeleft',function () {
        ...
        this.$projectInfo.hammer().on('swiperight',function () {
            var length = $('.divDetail').length;
    ...
    BeopMap.prototype.initSingleProject = function (project) {
        ...
        if(ProjectConfig.projectId == project.id) {
            $main.append('<span class="iconSelect glyphicon glyphicon-ok-circle"></span>');
        }
        $main.css('background-image','url(http://images.rnbtech.com.hk/static/images/project_img/'+ project.pic +')');
        ...
        for (var i = 0;i < nearbyProjectList.length;i++) {
            ...
            strNearby.append('<div class="divDetail nearbyDetail" project-to="' + nearbyProjectList[i].id + '"style="background-image:url(http://images.rnbtech.com.hk/static/images/project_img/' + nearbyProjectList[i].pic +'">');
        ...
        $divDetail.hammer().off('tap').on('tap',function (e) {
            ...
            for (var i = 0; i < ProjectConfig.projectList.length;i++){
                if (ProjectConfig.projectList[i].id == id){
                    _this.initSingleProject(ProjectConfig.projectList[i]);
                    break;
                }
            }
        });
