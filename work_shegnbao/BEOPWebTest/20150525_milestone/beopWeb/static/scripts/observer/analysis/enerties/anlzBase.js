...
var AnlzBase = (function () {
    ...
    AnlzBase.prototype = {
        ...
        spinnerStop: function(){
            Spinner.stop();
            _this.spinnerRender.stop();
            _this.screen.spinnerSave && _this.screen.spinnerSave.stop && _this.screen.spinnerSave.stop();
        },
        close: function () { },
        ...
        createNote: function (note) {
            ...
            if(!note){
                ...
                _this.saveNote(note,true);
            }

            document.onmousemove = _this.doMove;
            document.onclick = _this.doClick;
        ...
        removeNote: function (obj) {
            if(confirm(i18n_resource.analysis.workspace.CONFIRM_NOTE_DELETE)){
                ...
                $divNote.remove();
                _this.screen.curModal.noteList.splice(_this.getNoteListIndex($divNote.attr('id')),1);
                _this.screen.saveModal();
                _this.screen.saveModalJudge.resolve(_this.screen);
            }
        },
