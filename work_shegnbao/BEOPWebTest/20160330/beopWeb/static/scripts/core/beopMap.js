...
(function (beop) {
    ...
    BeopMap.prototype.addToVersionHistory = function (isShowVersionInfo) {
        ...
        if (!(!!versionHistory) || versionHistory == 'undefined') {
            ...
            $controlBtn = this.createVersionHistory(versionHistory.version, isShowVersionInfo);
        }
    ...
    BeopMap.prototype.createVersionHistory = function (text, isShowVersionInfo) {
        ...
        if (isShowVersionInfo) {
            ...
            versionHistoryUI = $('<div class="map-beop-version-history" title="beop版本历史记录"><p  href="#page=VersionHistory"> beop version: ' + text + ' </p></div>');
        }
...
function mapLoadCallBack() {
    try {
        ...
        if (window.localStorage.getItem('language') == 'zh') {
            ...
            mapIns.addToVersionHistory(version.readUsers);
