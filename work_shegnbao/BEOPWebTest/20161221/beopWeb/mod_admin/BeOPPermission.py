...
class BeOPPermission:
    ...
    rawRoleTable = {
        ...
        12: {
            'name': 'BGeneralUser',
            'permission': ['RDashboard', 'WorkOrder', 'PWikiUser', 'RReport', 'DReport', 'ReportPushSet', 'DataReadUser']
        },
        13: {
            'name': 'BEngineer',
            'permission': ['DAnalysis', 'MShare', 'RTDataView', 'DBWrite', 'Html Write Value', 'RReport', 'DReport',
                           'ReportPushSet', 'PWikiUser', 'BGeneralUser', 'WFUser', 'TeamSet', 'DataManagementAdmin']
        },
        14: {
            'name': 'BManager',
            'permission': ['SOPermissions', 'MOAccount', 'StandardSet', 'InviteUser', 'Benchmark',
                           'ProjectVSet', 'PWikiUser', 'BEngineer', 'DataManagementManager']
        },
        15: {
            'name': 'BAdmin',
        ...
        16: {
            'name': 'DCROnly',
            'permission': ['RDashboard', 'DataReadUser']
        },
        17: {
            'name': 'DCDataAnalyst',
            'permission': ['DAnalysis', 'MShare', 'RTDataView', 'DCROnly', 'RReport', 'DReport', 'ReportPushSet',
                           'Benchmark', 'ProjectVSet', 'WorkOrder', 'PWikiUser', 'DataManagementEngineer']
        },
        18: {
            'name': 'DCEngineer',
