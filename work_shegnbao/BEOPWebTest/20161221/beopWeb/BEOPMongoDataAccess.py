...
class BEOPMongoDataAccess:
    ...
    def getHistoryDataByFormat(self,projId, dbname, pointList, timeStart, timeEnd, timeFormat):
    ...
    def get_asset_operation_log(self, data):
        ...
        try:
            ...
            for item in rt:
                ...
                if newData:
                    newData.update({'_id': newData.get('_id').__str__()})
                ...
                if oldData:
                    oldData.update({'_id': oldData.get('_id').__str__()})
