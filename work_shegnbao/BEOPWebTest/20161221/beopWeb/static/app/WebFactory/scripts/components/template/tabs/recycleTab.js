...
;(function (exports, SuperClass) {
    ...
    RecycleTab.prototype = Object.create(SuperClass.prototype);
    RecycleTab.prototype.constructor = RecycleTab;
    ...
    +function () {
        ...
        /** @override */
        this.tabOptions = {
            title:'<div class="divTab"><span class="glyphicon glyphicon-tree-deciduous"></span>Recycle</div>',
    ...
    }.call(RecycleTab.prototype);

    exports.RecycleTab = RecycleTab;
