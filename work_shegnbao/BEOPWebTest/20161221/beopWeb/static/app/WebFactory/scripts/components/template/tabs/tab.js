;(function (exports) {
    ...
    +function () {
        ...
        this.showInfo = function(materialInfo,userName){
            ...
            var nameTime = '<div class="col-xs-4 item-nameF">创建人:</div><div class="item-name col-xs-8" title="'+userName+'">' + userName + '</div>'+
                '<div class="col-xs-4 item-nameF">创建时间:</div><div class="col-xs-8 item-name" title="'+contentTime+'">' + contentTime + '</div>';
            contentInfo += '<div class="col-xs-4 item-nameF">名称:</div><div class="col-xs-8 item-name" title="'+contentName+'">' + contentName + '</div>';
            if (materialType.indexOf('image')>=0) {
                ...
                contentInfo += '<div class="col-xs-4 item-nameF">大小:</div><div class="col-xs-8 item-name" title="'+contentW+'*'+contentH+'">' + contentW+'*'+contentH + '</div>';
                if(contentIterval&&parseInt(contentIterval)!==0){
                    contentInfo += '<div class="col-xs-4 item-nameF">速度:</div><div class="col-xs-8 item-name" title="一秒'+(1000/parseInt(contentIterval)).toFixed(2)+'帧">一秒' + (1000/parseInt(contentIterval)).toFixed(2) + '帧</div>';
                ...
                contentInfo += '<div class="col-xs-4 item-nameF">类型:</div><div class="col-xs-8 item-name" title="'+pageType+'">'+pageType+'</div>';
                contentInfo+=nameTime;
                ...
                contentInfo += '<div class="col-xs-4 item-nameF">类型:</div><div class="col-xs-8 item-name" title="'+widgetType+'">'+widgetType+'</div>';
                contentInfo+=nameTime;
                contentInfo += '<div class="col-xs-12 item-previewImg"><div class="previewImg"></div></div>';
            }else{
                contentInfo+=nameTime;
                    ...
                    if($tplItemHover.hasClass('photoItem')){
                        ...
                        function loadImage(result){
                            if(result.previewUrl){
                                ...
                                imgLoad.src = 'http://images.rnbtech.com.hk/' +result.previewUrl;
                                //当图片成功加载到浏览器缓存
                                imgLoad.onload =function(e){
                                    ...
                                    if ((imgLoad.readyState == 'complete' || imgLoad.readyState == 'loaded') || imgLoad.complete) {
                                        var url = 'http://images.rnbtech.com.hk/'+result.previewUrl;
