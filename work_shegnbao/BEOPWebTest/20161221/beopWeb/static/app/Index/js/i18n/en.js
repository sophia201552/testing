var i18n_resource = {
    ...
    platform: {
        platSwip: {
            ...
            ONE_BTN: "Automatic conclusions by natural language",
            TWO_BTN: "Learning algorithms to become smarter",
            THREE_BTN: "Rule library/ Knowledge base",
            FOUR_BTN: "Open & interoperable for third party application & development"
        },
        onePart: {
    ...
    services: {
        endUser: {
            ...
            ONE_PART_CON: "Based on historical and real-time data, BeOP™ detects faults or incorrect operation of equipment and systems and diagnoses them for further actions.",
            TWO_PART_TITLE: "Asset Management",
            TWO_PART_CON: "Record regular maintenance, equipment use, and live diagnostics history to ensure asset integrity and facilitate its appraisal and evaluation.",
            THREE_PART_TITLE: "Smart KPI",
            THREE_PART_CON: "Customized operation KPI management visualizes critical operation parameters and automatically diagnoses KPIs that fails to achieve. Periodic report are automatically generated and delivered to users.",
            FOUR_PART_TITLE: "Energy Management",
            FOUR_PART_CON: "A complete set of online energy service on BeOP™ Platform, including but not limited to, energy audit, benchmarking and diagnostics, measurement & verification, ROI analysis, and automatic reporting, etc., tremendously improves working efficiency of energy service business.",
            FIVE_PART_TITLE: "Digital Workflow",
            FIVE_PART_CON: "Automatically drive actions from raw data. Track and visualize entire process of detected faults by monitoring processing, status, and efficiency.",
            SIX_PART_TITLE: "Data Analysis Tool",
            SIX_PART_CON: "Professional cloud-based data analysis tool easy to use. A combination of Excel and PowerPoint that allows users to manage, calculate, visualize, and share data analysis with great convenience and flexibility."
        },
        platUser: {
    ...
    smartDevices: {
        ...
        TWO_PART_TITLE: "Smart Thermostat Network ",
        TWO_PART_TITLE_TWO:"for High End Commercial Building",
        ...
        THREE_PART_SWIP_ONE_TITLE: "Energy efficient",
    ...
    industry: {
        ...
        TWO_PART_ONE_CON: "IoT service for mechanical equipment make the aftermarket service more convenient and efficient.",
        TWO_PART_TWO_TITLE: "Operation management:",
        TWO_PART_TWO_CON: "Centrally and remotely optimized operation",
    ...
    company: {
        ...
        THREE_PART_THREE_SUBTITLE: "R&B Technology Company Limited",
    ...
    news: {
        ...
        TIME_LINE_TWO_CONTENT:"Sign strategic cooperation framework agreement with CBRE<br>(world’s largest commercial real estate services and investment firm)",
        TIME_LINE_THREE_TIME:"March, 2016",
        TIME_LINE_THREE_CONTENT:"Publish configuration and debugging tools <br>for developers and allied partners",
        ...
        TIME_LINE_SIX_CONTENT:"Release cloud services for sophisticated machinery <br>& equipment and IoT",
        TIME_LINE_SEVEN_TIME:"April, 2014",
        TIME_LINE_SEVEN_CONTENT:"Complete Series A funding",
        TIME_LINE_EIGHT_TIME:"January, 2015",
        TIME_LINE_EIGHT_CONTENT:"Release version 1.0 of BeOP Platform<br>Provide smart services for engineering and building <br>energy facilities",
