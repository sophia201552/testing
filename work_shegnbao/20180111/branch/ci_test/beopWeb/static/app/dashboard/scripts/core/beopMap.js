...
(function (beop) {
    ...
    var configMap = {
        ...
        project_img_path: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/static/images/project_img/',
        ...
        online_img_path: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/static/images/map_marker_online.png',
        offline_img_path: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/static/images/map_marker_offline.png',
    ...
    BeopMap.prototype.addToVersionHistory = function () {
        ...
        if (!versionHistory) {
            $controlBtn = this.createVersionHistory('获取最新版本失败，请重新登录');
        } else {
    ...
    BeopMap.prototype.initSingleProject = function (project) {
        ...
        $main.css({
            'background-image': 'url(https://beopweb.oss-cn-hangzhou.aliyuncs.com/static/images/project_img/' + project.pic + ')',
            'width': divWidth + '%'
        });
        ...
        for (var i = 0; i < nearbyProjectList.length; i++) {
            ...
            strNearby.append('<div class="divDetail nearbyDetail zepto-ev" project-to="' + nearbyProjectList[i].id + '"style="width:' + divWidth + '%;background-image:url(https://beopweb.oss-cn-hangzhou.aliyuncs.com/static/images/project_img/' + nearbyProjectList[i].pic + ')">');
