;(function(root, factory) {
    ...
    class HistoricalCurveConfigPanel extends React.Component {
        constructor(props) {
            super(props);
                ...
                h(Content, {
                    ...
                    h(Header, {
                        ...
                        h('div.config-panel-title', [
                            I18n.resource.moduleContent.HISTORICAL_CURVE_MODULE_TO_EDIT+` - ${module.name}`
                        ]),
    ...
    exports.HistoricalCurveConfigPanel = HistoricalCurveConfigPanel;
}));