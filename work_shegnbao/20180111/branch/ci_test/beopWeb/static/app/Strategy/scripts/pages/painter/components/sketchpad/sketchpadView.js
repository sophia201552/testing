...
(function(root, factory) {
...
}(namespace('beop.strategy.components'), function(exports, React, ReactKonva, antd, GInputGroup, GOutputGroup, GShapeGroup, GGroupShape, GArrowGroup, GAlignmentLineGroup, Calculation, enumerators, Spinner, ShowTagsTableModal, diff, MergeDiff) {

    var h = React.h;
    var linkEvent = React.linkEvent;

    const { Affix, Button, Select, Modal, Tabs, Tree, Icon, Tag, Progress } = antd;
    const { TabPane } = Tabs;
    const { TreeNode } = Tree;
    ...
    class Stage extends React.Component {
        ...
        componentWillUnmount() {
            ...
            window.removeEventListener('resize',this.keyDown,false);
