;(function(root, factory) {
    ...
    class ThreeDimensionsViewConfigPanel extends React.Component {
        constructor(props) {
            super(props);
                ...
                h(Content, {
                    ...
                    h(Header, {
                        ...
                        h('div.config-panel-title', [
                            I18n.resource.moduleContent.TD_VIEW_MODULE_TO_EDIT+` - ${module.name}`
                        ]),
    ...
    exports.ThreeDimensionsViewConfigPanel = ThreeDimensionsViewConfigPanel;
}));