                        ...
                        h(FormItem, {
                            ...
                            getFieldDecorator('unit', {
                                ...
                                h(Select,{
                                    ...
                                    h(Option, { value: "温度(℃)" }, ["℃"]),
                                    h(Option, { value: "重量(Kg)" }, ["Kg"]),
                                    h(Option, { value: "能量(Kj)" }, ["Kj"]),
                                    h(Option, { value: "功率(kW)" }, ["kW"]),
                                    h(Option, { value: "电量(kWh)" }, ["kWh"]),
                                    h(Option, { value: "频率(Hz)" }, ["Hz"]),
                                    h(Option, { value: "流量(l/s)" }, ["l/s"]),
                                    h(Option, { value: "流量(m³/h)" }, ["m³/h"]),
                                    h(Option, { value: "帕(Pa)" }, ["Pa"]),
                                    h(Option, { value: "千帕(kPa)" }, ["kPa"]),
                                    h(Option, { value: "冷量(RT)" }, ["RT"]),
                                    h(Option, { value: "冷量(RTH)" }, ["RTH"]),
                                    h(Option, { value: "比例(%)" }, ["%("+ I18n.resource.modal.SCALE +")"]),
                                    h(Option, { value: "电流百分比(%)" }, ["%("+ I18n.resource.modal.CURRENT_PERCENTAGE +")"]),
                                    h(Option, { value: "开度(%)" }, ["%("+ I18n.resource.modal.OPENING +")"]),
                                    h(Option, { value: "人民币(RMB)" }, ["¥"]),
                                    h(Option, { value: "美元($)" }, ["$"])
