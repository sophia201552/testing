            ...
            while (tool = tools.shift()) {
                switch (tool) {
                    ...
                    case 'layouts':
                        ...
                        btn.onclick = function(e) {
                            ...
                            CodeEditorModal.show({
                                ...
                                confirm('是否立即替换报表结构？替换后不可恢复',function(){
                                    _this.clear();
                                    _this.render(true);
                                },function(){
                    ...
                    case 'pageBreak':
                        ...
                        btn.href = 'javascript:;';
                        btn.innerHTML = '<span class="glyphicon glyphicon-scissors"></span>';
                        divToolWrap.appendChild(btn);
                        btn.onclick = function(e) {
                            $(this).toggleClass('active');
                            _this.entity.modal.option.isPageBreak = !_this.entity.modal.option.isPageBreak;
                        };
                        break;
                }
            }
            ...
            if (!date) {
                ...
                switch (options.period || 'day') {
                    case 'week':
                        ...
                        date = new Date((now.valueOf() / 86400000 - weekDay) * 86400000).format('yyyy-MM-dd');
                        break;
                }
            }
