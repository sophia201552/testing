...
;(function (exports, tabsPackage) {
    ...
    +function () {
        ...
        this.show = function () {
            var _this = this;
            $.when(this._getHtml(),this._getUserGroup()).done(function () {
                // tabs 逻辑处理
                _this._initTabs();
                // 事件
                _this._attachEvents();
        ...
        //获取用户组
        this._getUserGroup = function() {
            var _this= this;
            if(AppConfig.templateUserList){
                return;
            }else{
                AppConfig.templateUserList = [];
            }
            return WebAPI.post('/admin/memberSelected/', {
                ...
                if(result.success){
                    ...
                    userList.push(1);
                    AppConfig.templateUserList = userList;
                }
            }).fail(function(){
                 AppConfig.templateUserList = [];
            })
