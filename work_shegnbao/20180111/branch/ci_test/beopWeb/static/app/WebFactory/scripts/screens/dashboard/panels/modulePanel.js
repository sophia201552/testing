            ...
            for (var i in group) {
                if (i == 0) {
                    ...
                    $div.on('mouseenter', function () {
                        ...
                        $(toolDiv).addClass('toolDiv').css({'top':$(this).offset().top - 30 + 'px'});
                        ...
                        $(dataDiv).html('<span i18n="dataSource.TITLE">数据源</span><span class="btnCopy" i18n="mainPanel.materalPanel.privateMateral.COPY">复制</span><pre class="dataStruct">' +desc+'</pre>');
                        I18n.fillArea($(dataDiv));
                        ...
                        $('.btnCopy').off('click').on('click', function(e){
                            ...
                            alert(I18n.resource.mainPanel.materalPanel.privateMateral.COPY_TO_CLIPBOARD);
                        });
