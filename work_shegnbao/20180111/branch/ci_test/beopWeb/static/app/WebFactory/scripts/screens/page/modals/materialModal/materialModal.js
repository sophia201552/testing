;(function (exports) {
    ...
    var DEFAULT_TABS = [
        {'title':'Template',data: ['Report','Page','Layer','Widget','Image'],id:null}
    ];
    ...
    +function () {
        ...
        this.show = function (tabs,callback) {
            ...
            for(var i = 0,len = this.tabs.length;i<len;i++){
                ...
                if(i === 0 && this.tabs[0].id){
                    this.showById = this.tabs[0].id;
                    delete this.tabs[0].id;
                }
            }
            //tabsArr.forEach(function(row){
        ...
        this.initTemplate = function () {
            ...
            if(this.showById){
                options.showEnumerationImgId = this.showById;
            }
