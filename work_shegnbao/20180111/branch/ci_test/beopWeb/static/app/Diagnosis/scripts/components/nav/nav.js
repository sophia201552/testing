...
;(function (exports, Structure, Fault, Category, TimePicker) {
    class Nav {
        ...
        init() {
            const htmlWrap = `<div id="listWrap"><div id="structure"></div><div id="category"></div><div id="fault"></div></div>`;
            this.container.querySelector('.diagnosis-v2-content').innerHTML = htmlWrap;
            this.initTimePicker();
            this.initStructure();
            this.initFault();
            this.initCategory();
        ...
        initTimePicker() {
            let timePickerDom = this.container.querySelector('.diagnosis-v2-header');
    ...
    exports.Nav = Nav;
} ( namespace('diagnosis.Pages.nav'), namespace('diagnosis.Pages.nav.Structure'), namespace('diagnosis.Pages.nav.Fault'), namespace('diagnosis.Pages.nav.Category'), namespace('diagnosis.Pages.nav.TimePicker') ));