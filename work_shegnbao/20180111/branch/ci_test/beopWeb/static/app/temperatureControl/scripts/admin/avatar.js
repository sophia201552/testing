    ...
    Avatar.prototype = {
        ...
        init: function(){
            ...
            if(AppConfig.userProfile){
                AppConfig.userProfile.picture && $('#bigAvatar', this.$main).attr('src', 'https://beopweb.oss-cn-hangzhou.aliyuncs.com' + AppConfig.userProfile.picture);
            }
        },
        close: function(){
            ...
            function upload(dataURL){
                WebAPI.post('/admin/base64ToImg', {'userId': AppConfig.userId, base64: dataURL.split('base64,')[1]}).done(function(result){
                    if (result.success) {
                        ...
                        $wrapImgCut.hide();
                        $bigAvatar.attr('src', 'https://beopweb.oss-cn-hangzhou.aliyuncs.com' + result.data).show();
                    } else {
