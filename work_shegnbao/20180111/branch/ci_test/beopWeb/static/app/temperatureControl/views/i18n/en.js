var i18n_resource = {
    ...
    admin: {
        ...
        setUp: {
            ...
            HOSTNAME: 'Hostname',
            IP: 'IP',
            DOWNLOAD_ROOM: 'Download Room',
            SWITCH_TO_LOCAL: 'Switch to Local',
            DOWNLOAD_ROOM: 'Download all room info',
            SWITCH_TO_LOCAL: 'Transfer to local control mode',
            DOWNLOAD_SUCCESS: 'All room info dowload successfully',
            DOWNLOAD_FAIL: 'Room info dowload fail',
        },
        controllers: {
            NAME: 'Name',
    ...
    observer:{
        mqtt:{
            PORT:'Port',
            CONNECT_ERR:'Local control connect fail',
        },
        cache:{
            ROOM_NO_CACHE:'There is no cache for the room\'s detail.'
        }
    },
    login:{
        ERROR_1:'The server is busy, transfer to local control mode for you'
    },
    iot: {
        IOT: 'IOT',
