...
;(function (exports) {
    class FaultDetailPanel {
        ...
        initFaultDetailPabel(data){
            ...
            if(this.detailArr){
                ...
                $.when(WebAPI.post('/diagnosis_v2/getFaultsByIds',{
                    ...
                    $("#leftFaultDetailPanel",_this.container).empty().append(_this.leftSlider.formatEL(_this.getDataOpt(_this.faultArr,msgArr[0]["data"],data)));
                    Spinner.stop();
        ...
        initRightSlider(data){
            ...
            var startTime = '2017-07-10 00:00:00';
            var endTime = '2017-07-11 20:59:59';
            var points = [];
