        ...
        panelCog.innerHTML =
            `
                <div class="form-group">
                    <label for="inputPtValUpper" class="col-xs-4 control-label" i18n="modalConfig.data.PT_UPPER">` + I18n.resource.modalConfig.data.PT_UPPER +
            `</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group">
                    <label for="inputPtValLower" class="col-xs-4 control-label" i18n="modalConfig.data.PT_LOWER">` + I18n.resource.modalConfig.data.PT_LOWER + `</label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control lower" data-role="lower" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPtUnit" class="col-xs-4 control-label" i18n="modalConfig.data.PT_UNIT">` + I18n.resource.modalConfig.data.PT_UNIT + `</label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control unit" data-role="unit" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPtAccuracy" class="col-xs-4 control-label" i18n="modalConfig.data.PT_ACCURACY">` + I18n.resource.modalConfig.data.PT_ACCURACY + `</label>
                    <div class="col-xs-6">
                        <input type="text" class="form-control accuracy" data-role="accuracy" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputLineName1" class="col-xs-4 control-label" i18n="modalConfig.data.PT_LINE_1">` + I18n.resource.modalConfig.data.PT_LINE_1 + `</label>
                    <div class="col-xs-3">
                ...
                <div class="form-group">
                    <label for="inputLineName2" class="col-xs-4 control-label" i18n="modalConfig.data.PT_LINE_2">` + I18n.resource.modalConfig.data.PT_LINE_2 + `</label>
                    <div class="col-xs-3">
                ...
                <div class="form-group">
                    <label for="inputLineName3" class="col-xs-4 control-label" i18n="modalConfig.data.PT_LINE_3">` + I18n.resource.modalConfig.data.PT_LINE_3 + `</label>
                    <div class="col-xs-3">
                ...
                <div class="form-group">
                    <label for="inputLineName4" class="col-xs-4 control-label" i18n="modalConfig.data.PT_LINE_4">` + I18n.resource.modalConfig.data.PT_LINE_4 + `</label>
                    <div class="col-xs-3">
                ...
                <div class="divBtnCogGrp">
                    <button type="button" class="btn btn-primary btnCogConfirm" i18n="modalConfig.data.PT_COG_SURE">` + I18n.resource.modalConfig.data.PT_COG_SURE + `</button>
                    <button type="button" class="btn btn-primary btnCogCancel" i18n="modalConfig.data.PT_COG_CANCEL">` + I18n.resource.modalConfig.data.PT_COG_CANCEL + `</button>
                </div>
            `;
        panelCog.style.display = 'none';
        I18n.fillArea($('.panelChartCog .form-horizontal'));
        var _this = this;
...
class DataInfoListData extends BaseDataWidget {
    ...
    createDataListTtl() {
        ...
        divTtl.innerHTML = '\
        <span class="spDataListTtl spDataListNameTtl" i18n="modalConfig.data.DATA_NAME">' + I18n.resource.modalConfig.data.DATA_NAME + '</span>\
        <span class="spDataListTtl spDataListDsTtl" i18n="modalConfig.data.DATASOURCE">' + I18n.resource.modalConfig.data.DATASOURCE + '</span>\
        <span class="spDataListTtl spDataListUnitTtl" i18n="modalConfig.data.DATA_UNIT">' + I18n.resource.modalConfig.data.DATA_UNIT + '</span>\
        <span class="spDataListTtl spDataListScaleTtl" i18n="modalConfig.data.DATA_ACCURACY">' + I18n.resource.modalConfig.data.DATA_ACCURACY + '</span>\
        ';
        return divTtl
    }
    ...
    createDataUnitDom(id) {
            ...
            <span class='spHoverTip'>` + I18n.resource.modalConfig.data.DATASOURCE_TIP + `</span>
        `;
...
class MultiDataConfigData extends BaseDataWidget {
    ...
    createTitleDom(title) {
        ...
        label.innerHTML = I18n.resource.modalConfig.option.TITLE_NEW;

        var dataTitleName = document.createElement('div');
        dataTitleName.className = 'divDataTitleName';
        dataTitleName.innerHTML = I18n.resource.modalConfig.option.TITLE_DATA;

        var iptTtl = document.createElement('input');
        iptTtl.className = 'iptRoleTtl form-control';
        iptTtl.setAttribute('type', 'text');
        iptTtl.setAttribute('placeholder', I18n.resource.modalConfig.option.TITLE_TIP);
        ...
        iptUnit.setAttribute('placeholder', I18n.resource.modalConfig.option.UINT);
        if (opt.unit) iptUnit.value = opt.unit;

        var iptScale = document.createElement('input');
        iptScale.className = 'iptRoleTtlScale form-control';
        iptScale.setAttribute('placeholder', I18n.resource.modalConfig.option.PT_ACCURACY);
    ...
    createDataUnitDom(id) {
        ...
        spTip.innerHTML = `
            <span class='spNormalTip glyphicon glyphicon-plus'></span>
            <span class='spHoverTip'>` + I18n.resource.modalConfig.option.TITLE_DATA_TIP + `</span>
        `;
        divDs.appendChild(spTip);
