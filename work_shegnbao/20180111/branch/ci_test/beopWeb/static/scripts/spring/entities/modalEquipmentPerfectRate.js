    ...
    ModalEquipmentPerfectRate.prototype.renderModalDom = function (dataList) {
        ...
        if (dataList.length === 0) {
            ...
            for (var i = 0, len = dataList.length; i < len; i++) {
                ...
                if (I18n.type === 'zh') {
                    var title = '本月'+dataList[i].SubSystemName+'的设备健康率是 ' + num + '%，&#10该指标主要体现故障严重程度对于设备整体可靠性的影响。';
                } else {
                    var title = 'The equipment health of '+dataList[i].SubSystemName+' is ' + num + '% in this month,&#10;which indicates the reliability of CHILLERS considering different impacts of faults detected.';
                }
