var ModalAppKPICollect = (function(){
	...
	ModalAppKPICollect.prototype.initConfigModalOpt = function () {
		var _this = this;
		//手动国际化
		this.configModalOpt.header.title=I18n.resource.modalConfig.TITLE;
		this.configModalOpt.area[0].data.param[0].name=I18n.resource.modalConfig.option.DATA_TITLE;
		this.configModalOpt.area[0].data.param[1].name=I18n.resource.modalConfig.option.DATA_SOURCE;
		this.configModalOpt.area[0].data.param[2].name=I18n.resource.modalConfig.option.DATA_UNIT;
		this.configModalOpt.area[0].data.param[3].name=I18n.resource.modalConfig.option.DATA_ACCURACY;
