...
var ModalKpiOverview = (function(){
    ...
    ModalKpiOverview.prototype.initConfigModalOpt = function(){
        var _this = this;
        //国际化
        this.configModalOptDefault.header.title = I18n.resource.toolBox.APP_HISTORY_QUERY.CONFIG_BTN;
        this.configModalOptDefault.area[0].data[0].name = I18n.resource.toolBox.modal.KPI_OVERVIEW;
