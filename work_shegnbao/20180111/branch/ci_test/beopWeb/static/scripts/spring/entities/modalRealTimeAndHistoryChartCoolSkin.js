var modalRealTimeAndHistoryChartCoolSkin = (function () {
    function modalRealTimeAndHistoryChartCoolSkin(screen, entityParams, _renderModal, _updateModal, _showConfigMode) {
        if (!screen) return;
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype = new ModalBase();
    modalRealTimeAndHistoryChartCoolSkin.prototype.optionTemplate = {
        ...
        maxHeight: 6,
        maxWidth: 12,
        type: 'modalRealTimeAndHistoryChartCoolSkin',
        scroll: true,
        needRefresh: false,
        tooltip: {
            'imgPC': true,
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.configModalOptDefault = {
        "header": {
            "needBtnClose": true,
            "title": "配置"
        },
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.initConfigModalOpt = function() {
        var _this = this;
        //国际化
        this.configModalOptDefault.header.title = I18n.resource.modalConfig.TITLE;
        this.configModalOptDefault.area[0].widget[0].name = I18n.resource.modalConfig.option.UINT;
        this.configModalOptDefault.area[1].widget[0].name = I18n.resource.modalConfig.option.LABEL_CHART_SELECT;
        this.configModalOptDefault.area[1].widget[0].opt.option[0].name = I18n.resource.modalConfig.option.CHART_SELECT_BAR;
        this.configModalOptDefault.area[1].widget[0].opt.option[1].name = I18n.resource.modalConfig.option.CHART_SELECT_LINE;
        this.configModalOptDefault.area[1].widget[1].name = I18n.resource.modalConfig.option.CHART_LINE_COLOR;
        this.configModalOptDefault.area[2].data[0].name = I18n.resource.modalConfig.data.DATA_CONFIG_TITLE;

        if (this.entity.modal.option) {
            this.configModalOpt.area[0].widget[0].opt.data = this.entity.modal.option.unit;
            ...
            this.configModalOpt.area[1].widget[1].opt.data = this.entity.modal.option.lineColor;
        }
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.setModalOption = function(option) {
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.showConfigMode = function() {

    };
    modalRealTimeAndHistoryChartCoolSkin.prototype.layout = function () { 
        var titleName = this.entity.modal.titleName
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.resize = function() {
        this.chart && this.chart.resize();
    };
    modalRealTimeAndHistoryChartCoolSkin.prototype.renderModal = function () {
        var _this = this;
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.updateModal = function (option) {
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.updateRealTimeModal = function () {
        var _this = this;
    ...
    modalRealTimeAndHistoryChartCoolSkin.prototype.renderChart = function (data, time) {
    ...
    return modalRealTimeAndHistoryChartCoolSkin;
})()