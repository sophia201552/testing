...
var ModalDiagnosisStruct = (function(){
    ...
    ModalDiagnosisStruct.prototype.initConfigModalOpt = function(){
        ...
        this.configModalOpt.area[0].widget[0].name=I18n.resource.modalConfig.option.SHOW_DETAILS;
        this.configModalOpt.area[1].data[0].name=I18n.resource.modalConfig.option.KPI_SOURCE;
