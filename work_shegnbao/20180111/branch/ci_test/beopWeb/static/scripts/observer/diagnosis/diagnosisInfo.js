            ...
            function spectrumCreate(detailInfoData) {
                ...
                for (var m = 0; m < timeIntervalObj.length; m++) {
                    ...
                    if ((currentnowType == 'fault' || currentnowType == 'workhours') && faultTimeArr.timeArr.length !== 0) {
                        var timeOne = Object.prototype.toString.call(faultTimeArr.timeArr[0])=='[object Array]'?faultTimeArr.timeArr[0][0]:faultTimeArr.timeArr[0];
                        ...
                        var timeTwo = faultTimeArr.endTime[0] ? faultTimeArr.endTime[0] : timeOne.split(' ')[0]+' '+timeHMS;//new Date().format('yyyy-MM-dd HH:mm:ss');
