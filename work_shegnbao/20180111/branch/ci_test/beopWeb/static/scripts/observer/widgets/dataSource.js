    ...
    DataSource.prototype = {
        ...
        tagDragGroupStart: function (e, treeNode, tar) {
            ...
            var getGroup = function (treeNode, arr, parentName) {
                if (treeNode.equipmentId && treeNode.equipmentId !== null) {//有equipmentId说明是设备 无需查找子文件夹
                    if (treeNode.children) {
                        ...
                        arr.push({
                            ...
                            equipmentId: treeNode.equipmentId
                        });
                    } else {
                        arr.push({
                            _id: treeNode._id,
                ...
                } else if (treeNode.type == 'group') {//普通文件夹
                    arr.push({
                        _id: treeNode._id,
                        tag: treeNode.tag,
                        name: treeNode.name,
        ...
        tagDragPointStart: function (e, name, id) {
            var projId = beop.tag.externalTree.getProjectId();
            e.originalEvent.dataTransfer.setData('tagItemId', '@' + projId + '|' + name);
            EventAdapter.setData({
                'dsItemId': id
            });
        },
