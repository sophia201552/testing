    ...
    DiagnosisHistoryChart.prototype = {
        ...
        refreshData: function () {
            ...
            var option_bindPoints = {
                title: {
                    text: I18n.resource.dataManage.REFERENCE_POINT_CURVE,
                    textStyle: {
                        fontSize: '16',
                        fontWeight: '700',
                        color: '#eee'
            ...
            var option_faults = {
                title: {
                    text: I18n.resource.dataManage.DIAGNOSIS_CURVE,
                    textStyle: {
                        fontSize: '16',
                        fontWeight: '700',
                        color: '#eee'
                        ...
                        switch (params[0].value) {
                            case -1:
                                ...
                                return params[0].name + "<br />" +
                                    params[0].seriesName + ': ' + I18n.resource.common.UNKNOWN;
                            case 0:
                                $faults_info.css('display', 'none');
                                return params[0].name + "<br />" +
                                    params[0].seriesName + ': ' + I18n.resource.common.NORMAL;
                            case 1:
                                $faults_info.css('display', 'block').html(params[0].name + "<br />" +
                                    params[0].seriesName + ': ' + I18n.resource.common.ALARM + "<br />" +
                                    fault.affect + "，" + fault.analysis + "<br />" +
                                    fault.problem + "&nbsp;" + "<br />" +
                                    fault.suggestion);
                                return params[0].name + "<br />" +
                                    params[0].seriesName + ': ' + I18n.resource.common.ALARM;
                        }
                    }
                },
                dataZoom: {
                ...
                yAxis: {
                    ...
                    axisLabel: {
                        ...
                        formatter: function (value) {
                            switch (value) {
                                case -1:
                                    return I18n.resource.common.UNKNOWN;
                                case 0:
                                    return I18n.resource.common.NORMAL;
                                case 1:
                                    return I18n.resource.common.ALARM;
                            }
                        }
                    }
                },
