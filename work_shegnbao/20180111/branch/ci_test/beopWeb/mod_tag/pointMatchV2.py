...
class CGA:
    ...
    def readtaglib(self):
        data = pd.read_excel(os.path.join(
            os.path.abspath(os.path.dirname(__file__)), 'taglib_pointmatch.xlsx'),
            'Sheet1')
    ...
    def MatchStringList(self,MatchStrList,Remian,splitchar):
...
if __name__ == '__main__':
    ...
    #CLlist 为最终的tag结果
    Alist,BList,Clist = CSMatch.MatchStringList(STRList,Retain1,['_','-','--','++'])
