...
def getAbnormity(projId, startTime=None, endTime=None):
    ...
    try:
        ...
        print('getAbnormity error:' + e.__str__())
        logging.error('getAbnormity error:' + e.__str__())
    return jsonify(data=rt)
...
def currentMonthCompleteRate():
    ...
    try:
        ...
        logging.error('currentCompleteRate error: %s' % e.__str__())
...
def lastMonthCompleteRate():
    ...
    try:
        ...
        logging.error('lastMonthCompleteRate error: %s' % e.__str__())
        return jsonify(dict(msg=e.__str__(), error=1))
...
def getCompleteRate():
    try:
        ...
        logging.error('getCompleteRate error: ' + e.__str__())
        return jsonify(dict(msg=e.__str__(), error=1))
...
def kaineng_log_save():
    ...
    try:
        ...
        print('kaineng_log_save error:' + e.__str__())
...
def kaineng_get_report_baseOnMission(projId, startTime, endTime):
    ...
    try:
        ...
        print('kaineng_get_report_baseOnMission error:' + e.__str__())
        logging.error(e.__str__())
    return jsonify(rt)
