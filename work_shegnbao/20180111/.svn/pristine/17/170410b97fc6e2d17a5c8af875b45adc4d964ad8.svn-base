...
import copy
from beopWeb.observer import checkTime, getOneItemData
...
def factoryCopyPages():
    ...
    data = {
        'pageList': [],
        'destProjId': '592914ee833c977c9ea9187b'
    }
...
def getHistoryDataBy_str(strItem):
    ...
    strData = BEOPDataAccess.getInstance().get_history_data_padded(strProjectId, strItem.get('dsItemIds'), strItem.get('timeStart'), strItem.get('timeEnd'),
