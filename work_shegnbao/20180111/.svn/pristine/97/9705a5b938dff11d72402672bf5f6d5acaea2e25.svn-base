    ...
    class Layer extends React.Component{
        ...
        createInAndOut(isDebug, modules, inputActions, outputActions, stageActions) {
            ...
            function createInput(input, module, index) {
                ...
                }else if(module.option.isHideFormula=='show' && input.option &&  (input.option.type == enumerators.fuzzyRuleInputOutputTypes.FORMULA || input.option.type == enumerators.fuzzyRuleInputOutputTypes.SERIESANALYSISCODE)){
