(function(beop) {
    ...
    onGroupTypeChange = function() {
        ...
        if ($this.val() == 0) {
            ...
            jqueryMap.$group_ul.find('li[grouptype=1]').show();
            jqueryMap.$group_ul.find('li[grouptype=2]').hide();
        } else {
            jqueryMap.$group_ul.find('li[grouptype=1]').hide();
            jqueryMap.$group_ul.find('li[grouptype=2]').show();
        }
