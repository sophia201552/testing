...
assets.register('diagnosis_js_bundle', Bundle(
    ...
    'app/Diagnosis/scripts/components/feedBackModal/workOrderTask.js',
    'app/Diagnosis/scripts/components/feedBackModal/workOrderSpectrum.js',
    'app/Diagnosis/scripts/components/feedBackModal/workOrderBlank.js',
    'app/Diagnosis/scripts/components/feedBackModal/feedBackModal.js',
    'app/Diagnosis/scripts/components/workOrderModal/workOrderModal.js',

    'app/Diagnosis/scripts/components/taskModal/taskModal.js',
    ...
    'app/Diagnosis/scripts/pages/Overview/components/pointToAnalysis.js',
    ...
    'app/Diagnosis/scripts/pages/Task/components/faultTable/faultTable.js',
    'app/Diagnosis/scripts/pages/Task/task.js',
    'app/Diagnosis/scripts/pages/CaseRecord/components/faultDetailPanel.js',
    'app/Diagnosis/scripts/pages/CaseRecord/components/faultTable.js',
    'app/Diagnosis/scripts/pages/CaseRecord/caseRecord.js',
