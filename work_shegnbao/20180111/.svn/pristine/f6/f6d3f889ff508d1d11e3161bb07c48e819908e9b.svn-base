...
(function(root, factory) {
    ...
    var theme = {
        ...
        propView: function(data, changeProp, changeTrigger,editTrigger,btnLoading) {
            //兼容
                data.level = data.level == undefined ? 0 : data.level;
            //兼容end
            ...
            if('level' in data){
                ...
                children.push(
                    createRow(
                        I18n.resource.propTree.LEVEL,
                        h('select', {
                            name: 'level',
                            value: data.level,
                            onChange: linkEvent('level', changeProp)
                        }, [
                            h('option', { value: enums.strategyLevels.STRATEGY }, [enums.strategyLevelsNames[enums.strategyLevels.STRATEGY]]),
                            h('option', { value: enums.strategyLevels.SYSTEM }, [enums.strategyLevelsNames[enums.strategyLevels.SYSTEM]])
                        ])
                    )
                );
            }
    ...
    function PropPanel(props) {
        ...
        return (
            h('div', {
                ...
                theme.propView(data, changeProp, changeTrigger,editTrigger,btnLoading),
