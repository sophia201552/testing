...
var AnalysisScreen = (function () {
    ...
    AnalysisScreen.prototype = {
        ...
        init: function () {
            ...
            this.arrToolBox = [
                ...
                [{
                    ...
                    id: 'btnMoveTo',
                    title: 'Move to Other workspace'
                }, {
                    type: 'glyphicon',
                    value: 'glyphicon glyphicon-share',
                    id: 'btnShareTo',
                    title: 'Create Share Report'
                }, {
                    type: 'glyphicon', value: 'glyphicon glyphicon-play', id: 'btnPlay', title: 'Play Sliders'
                }, {
                    type: 'button',
                    value: i18n_resource.analysis.workspace.REVERSE_SELECT,
                    id: 'btnSelectReverse',
                    title: i18n_resource.analysis.workspace.REVERSE_SELECT
                }, {
                    type: 'button',
                    value: i18n_resource.analysis.workspace.SELECT_ALL,
                    id: 'btnSelectAll',
                    title: i18n_resource.analysis.workspace.SELECT_ALL
                }],
                ...
                [{
                    ...
                    id: 'btnConfigModal',
                    title: i18n_resource.analysis.workspace.CONFIG
                }, {
                    type: 'glyphicon',
                    value: 'glyphicon glyphicon-edit',
                    id: 'btnCreateNote',
                    title: i18n_resource.analysis.workspace.CREATE_NOTE
                }, {
                    type: 'glyphicon',
                    value: 'glyphicon glyphicon-eye-open',
                    id: 'btnNoteHideOrShow',
                    title: i18n_resource.analysis.workspace.NOTE_SHOW_HIDE
                }, {
                    type: 'glyphicon',
                    value: 'glyphicon glyphicon-th-large',
                    id: 'graphSelsect',
                    title: i18n_resource.analysis.workspace.SELECT_GRAPHS
                },
                    //{
                    ...
                    //},
                    {
                        ...
                        id: 'btnDataFilter',
                        title: i18n_resource.analysis.workspace.DATA_FILTER
                    },
                    {
                        type: 'glyphicon',
                        value: 'glyphicon glyphicon-download-alt',
                        id: 'btnDownLoadExcel',
                        title: i18n_resource.analysis.workspace.DOWNLOAD_EXCEL
                    }],
                // templateList - 3
                [{
                    type: 'glyphicon',
                    value: 'glyphicon glyphicon-log-in',
                    id: 'btnReturnToWorkspace',
        ...
        initItemTools: function () {
            ...
            EventAdapter.on($(this.$itemTools.children('#btnPreview').off('click')), 'click', function (e) {
                _this.preview();
            });
            EventAdapter.on($(this.$itemTools.children('#btnShareTo').off('click')), 'click', function (e) {
                _this.shareTo();
            });
            EventAdapter.on($(this.$itemTools.children('#btnPlay').off('click')), 'click', function (e) {
                _this.play();
            });
            EventAdapter.on($(this.$itemTools.children('#btnSelectAll').off('click')), 'click', function (e) {
                _this.selectAll();
            });
            EventAdapter.on($(this.$itemTools.children('#btnSelectReverse').off('click')), 'click', function (e) {
                _this.selectReverse();
            });
            EventAdapter.on($(this.$itemTools.children('#btnShowTemplate').off('click')), 'click', function (e) {
                _this.showTemplate();
            });
            EventAdapter.on($(this.$itemTools.children('#btnReturnToWorkspace').off('click')), 'click', function (e) {
                _this.returnToWorkspace();
            });
            EventAdapter.on($(this.$itemTools.children('#btnMoveTo').off('click')), 'click', function (e) {
                _this.moveTo();
            });
        ...
        saveWorkspaceLayout: function () {
            ...
            WebAPI.post('/analysis/workspace/saveOrder/' + AppConfig.userId, {
                idList: this.store.workspaces.map(function (row) {
                    return row.id;
                })
            }).done(function () {
        ...
        saveModalLayout: function () {
            ...
            WebAPI.post('/analysis/modal/saveOrder/' + AppConfig.userId + '/0', {
                workspaceId: ws.id,
                idList: ws.modalList.map(function (row) {
                    return row.id;
                })
            }).done(function () {
        ...
        alertNoData: function () {
            ...
            new Alert($dataAlert, "danger", "<strong>" + I18n.resource.analysis.paneConfig.ERR11 + "</strong>").show(1000);
        ...
        preview: function () {
            ...
            var wsIdsNeedLoad = [];
            var selectedWsIds = ([]).map.call($(this.container).find('.wsSet.on'), function (row) {
        ...
        showModal: function () {
            ...
            var $dialogContent = $dialog.find('#dialogContent').css({
                height: '90%',
                width: '90%',
                margin: 'auto',
                marginTop: '2.5%',
        ...
        showTemplate: function () {
            ...
            if (!this.store.templates) {
                pjIds = AppConfig.projectList.map(function (row, i) {
                    return row.id;
                });
