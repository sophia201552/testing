/**
 * modified from https://github.com/mlmorg/react-konva
...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports', 'React', 'Konva'], factory);
    } else if (typeof module === 'object' && module.exports) {
        factory(exports, require('React'), require('Konva'));
    } else {
        factory(
            root,
            root.React,
...
}(window, function(exports, React, Konva) {
    var ReactInstanceMap = React.ReactInstanceMap;
    var ReactMultiChild = React.ReactMultiChild;
    var ReactUpdates = React.ReactUpdates;
    ...
    var shapes = [
        'Rect', 'Line', 'Image', 'Text', 'Label', 'Arrow', 'Shape'
    ];
