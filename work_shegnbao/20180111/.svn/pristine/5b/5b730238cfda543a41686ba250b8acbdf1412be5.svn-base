;(function (exports, SuperClass) {
    ...
    +function () {
        this.DEFAULTS = {
            htmlUrl: '/static/app/WebFactory/scripts/screens/report/components/container/containerConfigModal.html'
        };
    ...
    exports.ContainerConfigModal = new Modal();
