...
(function(exports, THeatP, THeat3D, THeatColor) {
    ...
    <ul class="dropdown-menu dropdown-menu-right" style="left:32px;top:-15px;">\
        ...
        <li><a href="javascript:;" data-value="heat3D"><span class="iconfont icon-relituxuanqu" aria-hidden="true"></span><span class="heat3D">热力图3D</span></a></li>\
        <li><a href="javascript:;" data-value="heatColor"><span class="iconfont icon-relituxuanqu" aria-hidden="true"></span><span class="heatColor">热力图色板</span></a></li>\
    </ul>\
    </div>';
    var _this;
    ...
    function THeat(toolbar, container) {
        ...
        this.tHeat3D = undefined;
        this.tHeatColor = undefined;
        this.iconArr = ['icon-relitu', 'icon-relituxuanqu', 'icon-relitubiaoji', 'icon-relitu', 'icon-relitu'];
    ...
    THeat.prototype.init = function() {
        ...
        $(this.container).find('.heat3D').text(I18n.resource.mainPanel.tLayout.HEAT3D);
        $(this.container).find('.heatColor').text(I18n.resource.mainPanel.tLayout.HEATCOLOR);
    };
    ...
    //3d按钮点击执行
    THeat.prototype.heat3D = function(){
        this.tHeat3D = new THeat3D(this.toolbar, this.container);
        this.tHeat3D.show();
    }

    //color按钮点击执行
    THeat.prototype.heatColor = function(){
        this.tHeatColor = new THeatColor(this.toolbar, this.container);
        this.tHeatColor.show();
    }
    ...
    namespace('toolbar.THeat3D'),
    namespace('toolbar.THeatColor')
));