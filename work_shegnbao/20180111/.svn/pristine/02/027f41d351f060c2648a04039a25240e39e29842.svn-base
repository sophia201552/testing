(function() {
    ...
    function TBase(toolbar, container) {
        ...
        var toolbarTypeArr = ['pointerCtrl', 'handCtrl', 'textCtrl', 'btnCtrl', 'htmlCtrl', 'screenCtrl', 'imgeCtrl', 'pipeCtrl', 'zoomCtr', 'materalCtrl', 'gridLineCtrl', 'deviceCtr', 'layoutCtrl', 'heatCtrl', 'HTMLTpl', 'polygonCtrl', 'lineCtrl'];
        var toolbarTitleIner = [I18n.resource.mainPanel.toolbar.ARROW_TOOL, I18n.resource.mainPanel.toolbar.HAND_TOOL, I18n.resource.mainPanel.toolbar.TEXT_TOOL, I18n.resource.mainPanel.toolbar.BUTTON_TOOL,
            ...
            I18n.resource.mainPanel.toolbar.LAYOUT_TOOL, I18n.resource.mainPanel.toolbar.THERMODY_TOOL, I18n.resource.mainPanel.toolbar.HtmlContainer_TOOL, I18n.resource.mainPanel.toolbar.POLYGON_TOOL, I18n.resource.mainPanel.toolbar.LINE_TOOL
        ];
    ...
    TBase.prototype.dropActionPerformed = function(e) {
        ...
        if (data.type) {
            entity = {
                _id: ObjectId(),
                layerId: this.painter.getLayerId() || '',
                ...
                option: {
                    type: data.type,
                    display: (data.type === 'ModalColdHotAreaSummary' || data.type === 'ModalEquipmentPerfectRate' || data.type === 'ModalWorkOrderStatistics' || data.type === 'ModalPriorityHandlingFaultList' || data.type === 'ModalEnergyTrendAnalysis' || data.type === 'ModalEquipmentRateAndHistoryData' || data.type === 'ModalPriorityHandlingFaults') ? 0 : 1,
                    // display:1,
                    bg: 'blackBg', //默认 黑色字体
                    titleName: '',
                    titleCss: '',
            ...
            if(data.type == 'ModalEquipmentPerfectRate'){
                entity.option['isDataSource']=false
            }
