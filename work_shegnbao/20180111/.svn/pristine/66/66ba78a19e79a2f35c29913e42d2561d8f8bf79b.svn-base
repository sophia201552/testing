(function (WidgetProp) {
            ...
            <ul id="dataSList" class="list-inline" style="position: relative;">{dataSourceListHtml}\
                <li id="liDataSourceLogic" style="padding-top: 10px;width: 100%;">\
                    ...
                    <label class="radio-inline" style="margin: 0 5px 5px 5px;">\
                        <input type="radio" name="inlineRadioOptions" id="inlineRadioOr" value="0"> Or\
                    </label>\
                    <label class="radio-inline" style="margin: 0 5px 5px 5px;">\
                        <input type="radio" name="inlineRadioOptions" id="inlineRadioAnd" value="1"> And\
                    </label>\
                </li>\
    ...
    CanvasPipeProp.prototype.show = function () {
        ...
        var option = {
            ...
            pipeAnimation: (function (pipeAnimation) {
                ...
                switch (pipeAnimation) {
                    case 0:
                        rs = AppConfig.language === "zh"?'细线':I18n.resource.mainPanel.attrPanel.attrPipe.FINE_LINE;
                        break;
                    case 1:
                        rs = AppConfig.language === "zh"?'粗线':I18n.resource.mainPanel.attrPanel.attrPipe.THICK_LINE;
                        break;
                    case 2:
                        rs = AppConfig.language === "zh"?'气泡':I18n.resource.mainPanel.attrPanel.attrPipe.BUBBLE;
                        break;
                    default:
        ...
        $('#pipeAnimation label').text(I18n.resource.mainPanel.attrPanel.attrPipe.FLOW_PATTERN);
        $('#pipeAnimation').find("span[data-index = '0']").text(I18n.resource.mainPanel.attrPanel.attrPipe.FINE_LINE);
        $('#pipeAnimation').find("span[data-index = '1']").text(I18n.resource.mainPanel.attrPanel.attrPipe.THICK_LINE);
        $('#pipeAnimation').find("span[data-index = '2']").text(I18n.resource.mainPanel.attrPanel.attrPipe.BUBBLE);
        $('.pipe-dataSourceLogic').text(I18n.resource.mainPanel.attrPanel.attrPipe.LOGIC);
        //管道水流方向初始化
