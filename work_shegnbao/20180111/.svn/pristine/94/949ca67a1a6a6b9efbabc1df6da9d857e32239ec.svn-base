        ...
        $('.pdfDownCtn').on('click', function() {
                ...
                WebAPI.get('/static/views/share/reportWrap/coverPage.html').done(function(result) {
                    result = result.formatEL({
                        projectImg: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/custom/project_img/error.png',
                        title: reportTitle,
                        logo: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/custom/project_img/error.png',
