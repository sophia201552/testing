        ...
        renderDiagnosis:function(data){
            ...
            if(data.length!=0){
                for(var i = 0;i<data.length;i++){
                    ...
                    switch (item.Grade){
                        case 0:
                            grade = I18n.resource.diagnosis.config.LEVEL_SET.NOTE;
                            break;
                        case 1:
                            grade = I18n.resource.diagnosis.config.LEVEL_SET.CRITICAL;
                            break;
                        case 2:
                            grade = I18n.resource.diagnosis.config.LEVEL_SET.URGENT;
                            break;
                    }
                    trArrDom += trDom.formatEL({
                        ...
                        push: item.IsPush == 1 ? I18n.resource.diagnosis.config.subConfig.ENABLE : I18n.resource.diagnosis.config.subConfig.DISABLE,
