                        ...
                        if(i % listNum == 0){
                            for (var m = 0; m < arrItem.length; m++) {
                                if (_this.options.itemDS[0].arrId[i/listNum] == arrItem[m].id) {
                                    ...
                                    strToolTip += (data[0].timeShaft?data[0].timeShaft[params[i].dataIndex]:'--') + '<br/>Value: ' + (params[i].value?params[i].value:'--') + '<br/>';
                                    break;
                                }
                            }
                            ...
                            strToolTip +=(data[i % listNum].timeShaft?data[i % listNum].timeShaft[params[i].dataIndex]:'--') + '<br/>Value: ' +(params[i].value?params[i].value:'--') + '<br/>';
                        }
                    }
                    return strToolTip;
                }
