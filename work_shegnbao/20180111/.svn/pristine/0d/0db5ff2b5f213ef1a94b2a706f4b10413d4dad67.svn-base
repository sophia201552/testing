...
var OperatingPane = (function () {
    ...
    OperatingPane.prototype = {
        ...
        setValue: function () {
            ...
            if (AppConfig.projectId == 86) { //TODO: temp, coding for powerlinkdemo  86

                WebAPI.post("/set_to_site_by_projname", { db: AppConfig.projectName, point: this.pointName, value: this.value })
