;(function (exports, FacReportScreen) {
    ...
    +function () {
        ...
        this.attachEvents = function () {
            ...
            this.leftCtn.on('click', '.report-item', function () {
                ...
                if($(this).siblings("img").attr("src")=="/static/app/WebFactory/themes/default/images/down.svg"){
                    ...
                    _this._showReport(this.getAttribute('data-id'), period, date).always(function () {
                        _this.renderTree();
                    })
                }
            });
                ...
                promise.done(function (html) {
                    ...
                    xhr.onload = function () {
                        ...
                        if (this.status === 200) {
                            ...
                            if (ieVer>-1) {
                                window.navigator.msSaveBlob(blob, reportTitle + ' ' + $('.calendarCtn').children('input').val() + ' ' + reportPeriod +'.pdf');
                            } else {
                                ...
                                lkPdfFile.href = url;
                                lkPdfFile.download = reportTitle + ' ' + $('.calendarCtn').children('input').val() + ' ' + reportPeriod +'.pdf';
        ...
        this.centerCtnCon = function (){
            ...
            var pdfDownCon = '<span class="pdf_text">Download PDF</span>';
