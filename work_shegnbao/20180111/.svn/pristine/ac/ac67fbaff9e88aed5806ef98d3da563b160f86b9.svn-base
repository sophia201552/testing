;(function(root, factory) {
    ...
    var theme = {
        leftBtnGroup: function (selectedIds, nodeId, doAdd, doRemove, isShowTagTrabsfer, doTagTransfer,  showProjConfigModal,showSupplementModal,showUpdateDiagnosis) {
            let overlay = h(Menu,{},[
            ...
            return (
                h('.navLeftBtn', [
                    ...
                    h(ButtonGroup, {
                        ...
                        h(Button, {
                            loading: isShowTagTrabsfer,
                            onClick: doTagTransfer
                        }, I18n.resource.strategyTable.TAG_TRANSFER)
                    ])
                ])
            );
        },
    ...
    function StrategyTable(props) {
        ...
        return (
            h('div', {
                ...
                h('.toolBar.clearfix', [
                    theme.leftBtnGroup(selectedIds, selectedGroupId, doAdd, doRemove, isShowTagTrabsfer, doTagTransfer, showProjConfigModal,showSupplementModal,showUpdateDiagnosis),
