class EnergySave {
    ...
    init() {
        var _this = this;
        WebAPI.get('static/app/Benz/Kaide/views/energySaveScreen.html').done(function (result) {
            ...
            tooltip: {
                ...
                formatter: function (params) {
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        if (l > 1) {
                            total += parseFloat(params[i].value[1]);
                        }
                    }
                    if (l > 1) {
...
/*                formatter: function (params) {
        ...
        function getDataType(type) {
            ...
            data.forEach(function (element) {
                if (['savingPotential', 'water', 'elec'].indexOf(type) != -1) {
