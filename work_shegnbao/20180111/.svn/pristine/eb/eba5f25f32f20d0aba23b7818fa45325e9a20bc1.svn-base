var ConfigScreen = (function() {
    ...
    ConfigScreen.prototype = {
        ...
        initRoomTree: function() {
            ...
            this.roomTree = new HierFilter(this.$roomManagerPanel, AppConfig.projectList.map(function(item) { return item.id }), _this);
            this.roomTree.init();
            var option = {
                class: {
                    'projects': {
        ...
        initBaseInfoModal: function() {
            ...
            var $iptMapInitScale = $('#iptMapInitSize');
            var baseInfo;
            var tId = '',
                node;
            this.$roomManagerPanel.on('click', '.btnRoomConfig', function(e) {
                ...
                if (baseInfo.params.map && baseInfo.params.map.size) {
                    $iptMapInitScale.val(baseInfo.params.map.size)
                }
            ...
            btnBaseInfoConfirm.off('click').on('click', function(e) {
                ...
                if (baseInfo.params.map && parseFloat($iptMapInitScale.val())) {
                    baseInfo.params.map.size = parseFloat($iptMapInitScale.val())
                }
