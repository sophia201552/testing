...
class RedisManager:
    ...
    @classmethod
    def set_platform_point_history(cls, key, info):
        return cls.set(app.config['MEMCACHE_KEY_PREFIX'] + key, info)

    @classmethod
    def get_platform_point_history(cls, key):
        return cls.get(app.config['MEMCACHE_KEY_PREFIX'] + key)

    @classmethod
    def set_Dynamic_info_by_userId(cls, userId, info):
        return cls.set(app.config['MEMCACHE_KEY_PREFIX'] + 'dynamicInfo_' + str(userId), info)

    @classmethod
    def get_Dynamic_info_by_userId(cls, userId):
        return cls.get(app.config['MEMCACHE_KEY_PREFIX'] + 'dynamicInfo_' + str(userId))

    @classmethod
    def set_static_info_by_userId(cls, userId, info):
        return cls.set(app.config['MEMCACHE_KEY_PREFIX'] + 'staticInfo_' + str(userId), info)

    @classmethod
    def get_static_info_by_userId(cls, userId):
        return cls.get(app.config['MEMCACHE_KEY_PREFIX'] + 'staticInfo_' + str(userId))
    ...
    def set_project_locate_map(cls, info):
        """Forcibly update API: /projectMap/update"""
    ...
    def set_cloudpoints_site(cls, projId, info):
        """Forcibly update API: /cloudpoint/update"""
        strKey = app.config['MEMCACHE_KEY_PREFIX']+'cloudpoints_%d'%(int(projId))
        return cls.set(strKey, info)
    ...
    @classmethod
    def set_project_cluster_map(cls, info):
        """Forcibly update API: /projectClusterMap/update"""
        return cls.set(app.config['MEMCACHE_KEY_PREFIX'] + 'projectClusterMap', info)
    ...
    @classmethod
    def set_cluster_project_map(cls, info):
        """Forcibly update API: /projectClusterMap/update"""
        return cls.set(app.config['MEMCACHE_KEY_PREFIX'] + 'clusterProjectMap', info)
