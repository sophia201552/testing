...
with app.app_context():
    ...
    app.fac.regist("GroupPartM", "group")
    ...
    app.fac.regist("ThingPart", "thing")

    app.fac.regist("ThingLogistics", "thing")
    app.fac.regist("Warehouse", "thing.Logistics")
    app.fac.regist("Transporter", "thing.Logistics")
