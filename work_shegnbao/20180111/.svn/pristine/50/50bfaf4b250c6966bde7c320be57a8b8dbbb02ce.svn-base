    ...
    class ShowTextModal extends React.Component{
        ...
        createInput(selectedPutInfo, isFormat) {
            ...
            class InputComponent extends Input{
                ...
                render() {
                    return (h(Input, { id: 'debugValueInput', className:'gray-scrollbar', style:{maxHeight:'308px'}, type:'textarea', rows:8, defaultValue: this.state.value,value: this.state.value, onDragStart: preventFn,
                        onDragOver: preventFn, onDrop:this.dsDrop,onChange:this.change }));
                }
            }
            if(selectedPutInfo.isInput){
                ...
                if(type=='json'){
                    ...
                    return (h('div',{className:'gray-scrollbar variableView',
