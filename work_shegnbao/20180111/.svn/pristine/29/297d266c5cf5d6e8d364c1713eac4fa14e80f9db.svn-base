...
class AuthManager:
    ...
    checkless_endpoint_list = \
        ['login', 'logout', 'home', 'workflow.plan_list_today_tasks',
         ...
         'temp.getSchedule', 'temp.getRoomDetail', 'temp.check_timeout' ,'temp.getRoomList', 'workflow.sendWorkflowWeeklyReport',
         'check_user_by_phone', 'add_user_by_phone', 'message.get_message_by_user_id', 'company_index',
         'appCommon.getVersion',
         'page_contact', 'insert_into_contactus', 'set_realtimedata_from_site', 'temp.getRealtimeData', 'factory.factorySave', 'factory.factorySaveReportData',
         'factory.factoryRemoveReportData', 'report.upload_chart', 'send_verify_message_for_forgetpwd', 'forget_pwd_by_phone',
         'logistics','get_report_statfile', 'get_expert_container_url', 'admin.v_gen_captcha', 'register_new_user', 'admin.v_gen_verify_code','page_contact_v2']
