...
beop.constant = {
    ...
    BEOP_IMG_HOST: 'https://beopweb.oss-cn-hangzhou.aliyuncs.com',
...
(function(exports) {
    ...
    if (window.echarts) {
        echarts.registerPreprocessor(function(option) {
            //toolbox tooltip国际化
            if (I18n.type !== 'zh' && option.toolbox && option.toolbox.feature) {
                for (var key in option.toolbox.feature) {
                    if (I18n.resource.echarts && I18n.resource.echarts.toolbox[key] != undefined) {
                        option.toolbox.feature[key].title = I18n.resource.echarts.toolbox[key];
                    }
                }
            }
