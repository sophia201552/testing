...
var ModalReportFactory = (function(FacReportScreen){
    ...
    ModalReportFactory.prototype.modalDialog = '\
                ...
                <div class="row" style="margin-bottom: 15px;"><div class="col-xs-4 col-xs-offset-1"><input class="form-control" id="title" type="text" i18n="placeholder=dashboard.show.TITLE" placeholder="标题"/></div></div>';
    ...
    ModalReportFactory.prototype.showConfigModal = function () {
        ...
        I18n.fillArea($(this.configModal));
        this.attachEvents();
    ...
    ModalReportFactory.prototype.createItem = function(report){
        $('.modal-body', this.configModal.modal).append('<div class="row summaryRow" style="margin-bottom: 15px;">\
            ...
            <div class="col-xs-4">\
                <label class="checkbox-inline form-control" style="border: none;box-shadow: none;"> <input type="checkbox" class="isSummary" checked disabled> <span i18n="modalConfig.data.SHOW_SUMMARAY">仅显示摘要</sapn> </label>\
            </div>\
            <div class="col-xs-2">\
        ...
        I18n.fillArea($('.modal-body', this.configModal.modal));
    };
