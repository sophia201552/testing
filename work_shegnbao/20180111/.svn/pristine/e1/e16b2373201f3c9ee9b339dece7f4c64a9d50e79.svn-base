...
class Patrol(object):
    ...
    def getMissionInfo(cls, projId, dt):
        ...
        try:
            ...
            print('getMissionInfo error:' + e.__str__())
            logging.error('getMissionInfo error:' + e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def getMonthMissionRate(cls, projId, start, end):
        ...
        try:
            ...
            print('getMonthMissionRate error:' + e.__str__())
            logging.error('getMonthMissionRate error:' + e.__str__())
        return rt
    ...
    def getSingleMonthMissionRate(cls, projId, dt):
        ...
        try:
            ...
            print('getCurrentMonthMissionRate error:' + e.__str__())
            logging.error('getCurrentMonthMissionRate error:' + e.__str__())
        return rt
    ...
    def save_log_for_kaineng(cls, projId, post_data):
        insert_data = {'executorName': post_data.get('executorName'),
                       ...
                       'pathId': ObjectId(post_data.get('pathId')) if ObjectId.is_valid(post_data.get('pathId')) else post_data.get('pathId'),
                       'submitTime': datetime.now()}
    ...
    def kaineng_get_report_baseOnPath(cls, projId, startTime, endTime):
        ...
        try:
                                ...
                                if planDate >= ptime + timedelta(hours=12) and planDate <= ptime + timedelta(hours=36):
                                    ...
                                    if pid in option:
                                        ...
                                        if plantime.strftime('%H:%M') in pot.keys():
                                            if cls.judge_log_and_path(path_data.get(pid, {}).get('point'),
                                                                      [i.get('pointName').rstrip() for i in missionlog.get('path') \
                                                                      if i.get('pointName')]):
            ...
            print('kaineng_get_report_baseOnPath error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def get_path_for_kaineng(cls, projId):
        ...
        try:
            ...
            print('get_path_for_kaineng error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def get_executor_for_kaineng(cls, projId):
        ...
        try:
            ...
            print('get_executor_for_kaineng error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def kaineng_get_report_baseOnMan(cls, projId, startTime, endTime):
        ...
        try:
            ...
            print('kaineng_get_report_baseOnMan error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def kaineng_get_log_by_pathId(cls, projId, pathId, pTime):
        ...
        try:
            ...
            print('kaineng_get_log_by_pathId error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
    ...
    def kaineng_get_log_by_executorId(cls, projId, executorId, pTime):
        ...
        try:
            ...
            print('kaineng_get_log_by_executorId error:' + e.__str__())
            logging.error(e.__str__())
        return rv
    ...
    def kaineng_get_report_baseOnMan_v2(cls, projId, startTime, endTime):
        ...
        try:
            ...
            print('kaineng_get_report_baseOnMan_v2 error:' + e.__str__())
            logging.error(e.__str__())
        return rt
    ...
    def get_missionlog_by_exectorId_kaineng(cls, executorSn, startTime, endTime, path_data):
        ...
        try:
            ...
            print('get_missionlog_by_exectorId_kaineng error:' + e.__str__())
            logging.error(e.__str__())
        finally:
            if cursor:
                cursor.close()
