;(function (exports, SuperClass) {
    ...
    +function () {
        ...
        this.tabOptions = {
            ...
            itemTpl: '<div class="tpl-item report-item" draggable="true" id="{_id}" data-id="{_id}" data-type="{type}" data-groupid ="{group}" data-creator="{creator}"><div class="progress"></div><span class="glyphicon glyphicon-file"></span>\
        ...
        this.downFolder = function(result,upGroupData){
            ...
            $panelBody.find('.upGroup').off('dblclick').on('dblclick',function(){
                ...
                if(!_this.list[_this.list.length-2]){
                    ...
                    WebAPI.post('/factory/material/group/report',{userList:AppConfig.templateUserList}).done(function(result){
