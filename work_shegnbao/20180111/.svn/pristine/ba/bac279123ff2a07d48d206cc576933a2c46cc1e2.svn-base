(function (Widget, CanvasWidgetMixin) {
    ...
    CanvasImage.prototype._format = function () {
        ...
        if (typeof this.store.model.w === 'undefined') {
            this.store.model.property('w', 50);
        }
        if (typeof this.store.model.h === 'undefined') {
            this.store.model.property('h', 50);
        }
        if(!options.preview){
            options.preview = [];
        }
    ...
    CanvasImage.prototype.update = function (e, propName) {
        ...
        // 图片或枚举更改
        if ( !propName || propName.indexOf('update.option.trigger') > -1 || propName.indexOf('update.option') > -1 ) {
        ...
        // 图片方向更改
        if ( !propName || propName.indexOf('update.option.rotate') > -1 || propName.indexOf('update.option') > -1 ) {
    ...
    CanvasImage.prototype.loadImg = function (imageModel, imageModelId) {
        ...
        promise.done(function () {
            GUtil.loadImage(imageModel.url(), function (image) {
                var imgWidth = imageModel.w(), imgHeight = imageModel.h();
                ...
                if (imageModel.interval() > 0) {
                    ...
                    _this.shape.animations({
                        main: [0, 0, imageModel.pw(), imgHeight]
                    });
