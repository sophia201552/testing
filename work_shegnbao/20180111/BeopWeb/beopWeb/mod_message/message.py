...
class MessageType:
    ALLOW_TYPE = ["workflow", "diagnosis", "project", "versionHistory", "custom", "alarm"]
    WORKFLOW = "workflow",
    DIAGNOSIS = "diagnosis"
    PROJECT = "project"
...
class Message:
    ...
    # 添加工单的具体一条动态
    def add_new_workflow_message_with_return_id(self, sender_id, title, content, workflow_info, isMachine=False, subType=None):
