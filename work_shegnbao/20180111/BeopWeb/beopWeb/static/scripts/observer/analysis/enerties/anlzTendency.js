var AnlzTendency = (function () {
    ...
    AnlzTendency.prototype.createSeries = function (id, data, type) {
        ...
        if (type == this.legendType.NORMAL) {
            pointId= AppConfig.datasource.getDSItemById(id);
            var  alias = pointId.alias;
            if(alias &&  alias !== pointId.value){
                name = pointId.value + "(" +  alias + ")";
            }else{
                name = pointId.value; 
            }  
        }
            ...
            name = id.split('_');
            name = AppConfig.datasource.getDSItemById(name[0]).value + '_' + id[1];
        }
    ...
    AnlzTendency.prototype.createSeriesFilter = function (id, data, newId, condition) {
        ...
        name = AppConfig.datasource.getDSItemById(id).value + '_filter';
