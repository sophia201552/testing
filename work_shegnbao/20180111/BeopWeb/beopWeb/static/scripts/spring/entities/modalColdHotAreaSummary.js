    ...
    ModalColdHotAreaSummary.prototype.renderModal = function() {
        ...
        WebAPI.post('/analysis/startWorkspaceDataGenPieChart', option).done(function(result) {
            ...
            for (var i = 0; i < itemList.length; i++) {
                ...
                } else if (point === "AllRoom_UnderCool_svr" || ( point.split('_')[0] === "TotalThermalComfort" && point.split('_')[2]==='underCold') ) {
                    $(_this.container).find(".coldT").text(data);
                } else if (point === "AllRoom_OverHeat_svr" || ( point.split('_')[0] === "TotalThermalComfort" && point.split('_')[2]==='overHot') ) {
