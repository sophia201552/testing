    ...
    ModalMix.prototype.showConfigModal = function() {
        ...
        if ($mixChartShow.length === 0) {
            $mixChartShow = $('\
                            ...
                            <h4 class="modal-title" i18n="toolBox.modal.MIX_DISPLAY_MODAL">组合图显示模式</h4></div>\
                            <div class="modal-body">\
                            <div class="row">\
                            <div class="col-xs-3" i18n="toolBox.modal.MIX_SLIDER">组合图轮播</div>\
                            <div class="col-xs-6"><input type="number" id="iptInterval" i18n="placeholder=analysis.paneConfig.LABEL_INVERAL" style="width:100px"/>s<span i18n="toolBox.modal.NO_SLIDER_INFO">(0或者不填写表示不轮播)</span></div>\
                            </div>\
                            <div class="row">\
                            <div class="col-xs-3" i18n="toolBox.modal.BACKGROUND_COLOR">背景颜色</div>\
                            <div class="col-xs-2">\
                            <select id="selBgColor">\
                            <option value="transparent" i18n="toolBox.modal.NULL">无</option>\
                            <option value="#ffffff" i18n="toolBox.modal.WHITE">白</option>\
                            <option value="#000000" i18n="toolBox.modal.BLOCK">黑</option>\
                            <option value="#337ab7" i18n="toolBox.modal.BLUE">蓝</option>\
                            <option value="#5cb85c" i18n="toolBox.modal.GREEN">绿</option>\
                            <option value="custom" i18n="toolBox.modal.CUSTOM">自定义</option>\
                            </select>\
                            </div>\
                            ...
                            <div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal" id="btnSaveConfig" i18n="dashboard.modalJumpPages.CANCEL">确定</button></div>\
                            </div></div></div></div>');
        }
