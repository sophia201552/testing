        ...
        divMonitor.innerHTML =
            ...
            <div class="divMonitorInfo">\
                ...
                <div class="divType">\
                    ...
                    <select class="spType">\
                        <option i18n="modalConfig.data.VALUE">数值型</option>\
                        <option i18n="modalConfig.data.ALARM">报警型</option>\
                    </select>\
                </div>\
                <div class="divCol">\
                    <label>col:</label>\
                    <select class="iptCol form-control" value="1">\
                        <option value="0" i18n="modalConfig.data.ONE_LINE">一行</option>\
                        <option value="1" i18n="modalConfig.data.HALF_LINE">半行</option>\
                    </select>\
                </div>\
                <div class="divPoint">\
                    <label>decimal:</label>\
