    ...
    GroupProjectManager.prototype = {
        ...
        attachEvent: function () {
            ...
            $('#addProject').off('click').on('click', function () {
                ...
                $('#addGroupPage').modal();
                $('#addImg').hide();
                $('#codeName,#nameEnglish,#nameCN,#addPhone').val('')
            ...
            $('.config-btn').off('click').on('click', function () {
                ...
                var postData = {
                    ...
                    'phone': _this.clickProject.phone ? _this.clickProject.phone : ''
                }
                ...
                $('#divPhone').val(_this.clickProject.phone);
                var resetImage = new Image();
                var imgUrl = 'https://beopweb.oss-cn-hangzhou.aliyuncs.com/custom/management/' + _this.clickProject.id + '_logo.png?t=' + new Date().getTime();
                ...
                $('#updateProject').off('click').on('click', function () {
                    _this.clickProject.code_name = postData.code_name = $('#change_codeName').val();
                    _this.clickProject.name_en = postData.name_en = $('#change_nameEnglish').val();
                    _this.clickProject.name_cn = postData.name_cn = $('#change_nameCN').val();
                    _this.clickProject.phone = postData.phone = $('#divPhone').val();
            ...
            $("#updateGroupPage").off('change.fileUpload').on('change.fileUpload', '#fileUpload', function (e) {
                Spinner.spin(ElScreenContainer);
                try {
                    var self = this;
                    var fileList = e.target.files || e.dataTransfer.files;
                    ...
                    var path = (window.URL || window.webkitURL).createObjectURL(_this.uploadFile);
