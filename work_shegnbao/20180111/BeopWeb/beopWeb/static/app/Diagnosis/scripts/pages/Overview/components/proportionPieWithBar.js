                    ...
                    <div class="pieWidthBarContent">
                        ...
                        <div style="position: relative;top: 50%;transform: translateY(-50%);">
                            <div class="pieWidthBarRow">
                                <div class="pieWidthBarDot"> <span class="pieWidthBarDotBox" style="background:#66ccff"></span></div>
                                <div class="pieWidthBarName" title="BMS">BMS</div>
                                <div class="pieWidthBarData" title="18%">18%</div>
                            </div>
                            <div class="pieWidthBarRow">
                                <div class="pieWidthBarDot"> <span class="pieWidthBarDotBox" style="background:#f4c065"></span></div>
                                <div class="pieWidthBarName" title="Precise Air">Precise Air</div>
                                <div class="pieWidthBarData" title="30%">20%</div>
                            </div>
                            <div class="pieWidthBarRow">
                                <div class="pieWidthBarDot"> <span class="pieWidthBarDotBox" style="background:#ff9e9e"></span></div>
