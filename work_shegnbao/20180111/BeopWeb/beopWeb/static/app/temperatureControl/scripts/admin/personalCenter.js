...
var PersonalCenter = (function(){
    ...
    PersonalCenter.navOptions = {
        top: '<span class="navTopItem title middle" i18n="admin.setUp.PERSONAL_CENTER"></span>'
    };

    function PersonalCenter(container){
        this.container = container || ElScreenContainer;
    }
    ...
    PersonalCenter.prototype = {
        ...
        init: function(){
            ...
            if(AppConfig.userProfile){
                AppConfig.userProfile.picture && $('.imgUser', this.$main).attr('src', 'https://beopweb.oss-cn-hangzhou.aliyuncs.com' + AppConfig.userProfile.picture);
