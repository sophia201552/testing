var QualityManage = (function() {
    ...
    QualityManage.prototype = {
        ...
        initPointTr:function(type){
            var _this = this;
            var data = type=='fixed' ? this.fixedPtStore : (type=='move' ? this.movePtStore : this.coolStorage);
            var trdom = '';
        ...
        attachEvent: function() {
            ...
            $('#poinTInfoCommit').off('click').on('click',function(){
                ...
                if($.isEmptyObject(_this.commitDataObj)){
                    ...
                    var type = _this.type == 'fixed' ? 0 : (_this.type == 'move' ? 1 : 2);//$('.pointListTable').find('tr').eq(1).attr('data-type')=='fixed'
                    var commitDataArr = [];
        ...
        onPointTypeClick:function(type){
            ...
            var points = [];
            var currentPointArr = type=='fixed' ? this.fixedPtStore : (type=='move' ? this.movePtStore : this.coolStorage);
