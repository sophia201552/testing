var DataStatistic = (function() {
    ...
    DataStatistic.prototype = {
        ...
        getStatisticData: function() {
            ...
            var postDataCount = NavTree.focusGroup == 'fixed' ? 0 : (NavTree.focusGroup == 'move' ? 1 : 2);
            this.requestOnLoading = WebAPI.post('/logistics/thing/getStatisticalList/' + postDataCount, this.queryConfig).done(function(result) {
                try {
