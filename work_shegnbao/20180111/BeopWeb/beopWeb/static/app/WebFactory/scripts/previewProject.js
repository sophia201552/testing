...
+function (window) {
    ...
    $(document).ready(function () {
        var $promisProject = initUnit();
        var $promiseI18n = initI18n();
        $.when($promiseI18n,$promisProject).always(function(){
    ...
    function initI18n(){
        ...
        InitI18nResource(AppConfig.language, true, I18N_PATH).always(function(rs) {
            I18n = new Internationalization(null, rs);
            I18n.getProjectI18n(AppConfig.projectId).always(function(){
                $promise.resolve();
            })
        });
    ...
    function initUnit(){
        ...
        if(AppConfig.projectId !== ""){
            WebAPI.get('/project/getinfo/'+AppConfig.projectId).done(function(rs){
                ...
                AppConfig.projectCurrent = rs.projectinfo;
