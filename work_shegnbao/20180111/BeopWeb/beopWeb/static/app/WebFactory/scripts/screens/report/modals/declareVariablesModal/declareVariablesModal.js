;(function (exports) {
    ...
    +function () {
        // 显示组件
        this.show = function (data, callback, modes,container) {
            var _this = this;
            ...
            if (this.$modalWrap) {
                this.$modalWrap.appendTo(container || document.body);
        ...
        // 组件初始化
        this.init = function (html,container) {
            ...
            this.$modalWrap.appendTo(container || 'body');
        ...
        this.renderTable = function (data,i) {
            ...
            if(typeof i === "number"){
                tpl = '<table class="dataSourceTable" data-no = "'+ i +'"><caption>'+ data.title +'</caption>'+
                        '<thead><tr><th style="width:15%;" i18n="report.VAR_DECLARATION_NAME">变量名</th><th i18n="report.VAR_DECLARATION_VALUE">对应值</th><th i18n="report.VAR_DECLARATION_DESC">描述</th></tr></thead><tbody></tbody></table>';
            }else{
                tpl = '<table class="dataSourceTable"><thead><tr><th style="width:15%;" i18n="report.VAR_DECLARATION_NAME">变量名</th><th i18n="report.VAR_DECLARATION_VALUE">对应值</th><th i18n="report.VAR_DECLARATION_DESC">描述</th></tr></thead><tbody></tbody></table>';
            }
            table = HTMLParser(tpl.slice());
            this.$modalContent.append($(table));
            I18n.fillArea(this.$modalContent);
        ...
        this.restoreData = function (data){
            var _this = this;
            try {
                var dataObj = JSON.parse(data.js);
                this.$modalContent.html("");
                reader(dataObj);
                function reader(arr) {
                    if(arr instanceof Array){
                        Object.keys(arr[0]).forEach(function (i) {
                            // 渲染一个表格
                            _this.renderTable(arr[0][i],parseInt(i));
