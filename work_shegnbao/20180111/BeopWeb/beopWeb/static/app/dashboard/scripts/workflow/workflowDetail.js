    ...
    WorkflowDetail.prototype = {
        ...
        initWkInfo: function() {
            try {
                ...
                if (store.createTime) {
                    createTime.innerHTML = new Date(+moment(store.createTime)).format('yyyy-MM-dd HH:mm');
                }
                ...
                dueTime.innerHTML = new Date(+moment(store.fields.dueDate)).format('yyyy-MM-dd');
        ...
        createCommentDom: function(comment) {
            ...
            if (comment.time) {
                time.innerHTML = new Date(+moment(comment.time)).format('yyyy-MM-dd HH:mm:ss');
            }
