...
var ProjectReport = (function() {
    ...
    ProjectReport.prototype = {
        ...
        init: function() {
            ...
            var url = '/report/getReport/' + (this.projectInfo.name_en_init?this.projectInfo.name_en_init:this.projectInfo.name_en) + '/' + _this.reportDetail.reportFolder + '/' + version;
            WebAPI.get(url).done(function(result) {
                ...
                ReportScreen.prototype.renderCharts($reportUnit)
                var $table = $('table');
