    ...
    class GInputGroup extends React.Component {
        ...
        createEvents(){
            ...
            return {
                ...
                nameTextHighLight: function(e){
                    if(e.isHighLight){
                        nametextColor = this.fill();
                        this.fill('#f6a405');
                    }else{
                        this.fill(nametextColor||this.fill());
                    }
                },
            ...
            return (
                h(ReactKonva.Group, this.props, [
                    h(ReactKonva.Rect, {
                        ...
                        fill: isDisabled?'#42494D':(isSelected?'#f6a405':'#697174'),
                    ...
                    h(ReactKonva.Text, {
                        ...
                        fontSize: FONTSIZE,
                        fontFamily: '微软雅黑',
                        fill: isDisabled?'#1B90CF':(isDebug?'rgb(45, 183, 245)':isSelected ? '#fff' : '#9fb0b8'),
                        ...
                        onNameTextHighLight: isDebug?doNth:actions.nameTextHighLight,
                    }),
                    h(ReactKonva.Text, { 
                        x: 0,
                        y: 0,
