    ...
    class InputOutputParamConfigPanel extends React.Component {
        ...
        createOkFn(type) {
            return function (data) {
                ...
                if(index > -1){
                    delete data._id;
                    Object.assign(oldData[index]["option"], data);
                    newData = oldData;
                }
        ...
        setInputOutputParams(data){
            ...
            if(searchValue){
                data = data.filter(v=>v.name.toLocaleLowerCase().indexOf(searchValue.toLocaleLowerCase())>-1);
            }
        ...
        componentDidUpdate() {
            if(this.toBottom){
                this.refs.putsList.scrollTop = this.refs.putsList.scrollHeight;
                this.toBottom = false;
            }
        }
