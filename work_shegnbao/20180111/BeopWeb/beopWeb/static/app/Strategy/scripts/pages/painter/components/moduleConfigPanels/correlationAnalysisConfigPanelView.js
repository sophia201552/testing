;(function(root, factory) {
    ...
    class CorrelationAnalysisConfigPanel extends React.Component {
        constructor(props) {
            super(props);
                ...
                h(Content, {
                    ...
                    h(Header, {
                        ...
                        h('div.config-panel-title', [
                            I18n.resource.moduleContent.CORRELATION_MODULE_TO_EDIT + ` - ${module.name}`
                        ]),
    ...
    exports.CorrelationAnalysisConfigPanel = CorrelationAnalysisConfigPanel;
}));