class EnergyAnalysis {
    ...
    attachEvent() {
        ...
        startTime = toDate(this.timeConfig).format('yyyy-MM-dd 00:00:00');
        endTime = toDate(this.timeConfig).format('yyyy-MM-dd 23:59:59');
        endTime.split(' ')[0] == toDate().format('yyyy-MM-dd 23:59:59').split(' ')[0] ? endTime = toDate().format('yyyy-MM-dd HH:00:00') : 1;
        //对应点名
        var dsIdList = {
    ...
    renderTwoLine(lineName) {
        ...
        var postData = {
            projectId: 528,
            pointList: lineName,
            timeStart: toDate('2017-06-06').format('yyyy-MM-dd 00:00:00'),
            timeEnd: toDate('2017-06-07').format('yyyy-MM-dd 23:59:59'),
            timeFormat: 'h1',
            prop: {}
        }
        Spinner.spin($('.curvePanelCanvas')[0]);
