...
class GM003(unittest.TestCase):
    testCaseID = 'GM003'
    projectName = "光明项目"
    buzName = '检查光明乳业数据权限/logistics/thing/getList'
    start = 0.0
    now = 0
    startTime = ""
    errors = []
    ...
    def check(self):
        addr = "http://%s/logistics/thing/getList" % (app.config['SERVERIP'])
        rt=None
