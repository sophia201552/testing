...
helpMapping_list = \
    [
        ...
        {'name': 'calc_max_in_month', 'add_id': 1, 'api_type': api_type.get(5), 'dis_cription': '求一个月中的最大值',
         'sample': "calc_max_in_month('pointname','m5')"},
...
helpMapping_list_en = \
    [
        ...
        {'name':'calc_max_in_month', 'add_id':1,'api_type':api_type_en.get(5),'dis_cription':'get max value of the data in this month', 'sample':"calc_max_in_month('pointname','m5')"},
